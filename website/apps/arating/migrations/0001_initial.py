...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('arating', ['Vote'])

        # Adding unique constraint on 'Vote', fields ['user', 'content_type', 'object_id']
        db.create_unique('arating_vote', ['user_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['user', 'content_type', 'object_id']
        db.delete_unique('arating_vote', ['user_id', 'content_type_id', 'object_id'])

        # Deleting model 'Vote'
        db.delete_table('arating_vote')
