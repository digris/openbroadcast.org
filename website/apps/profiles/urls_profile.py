...
from profiles.views import InvitationListView, InvitationDeleteView, ProfileListView, profile_mentor, profile_approve, ProfileDetailView
...
urlpatterns = patterns('profiles.views',
    ...
    url(r'^force-login/(?P<username>[-\w.-_@]+)/$', view='profile_force_login', name='profiles-profile-force-login'),
    ...
    url(r'^(?P<slug>[-\w.-_@]+)/$', ProfileDetailView.as_view(), name='profiles-profile-detail'),
