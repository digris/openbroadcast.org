...
urlpatterns = [
    ...
    url(r'^(?P<uuid>[0-9a-f-]+)/(?:(?P<section>[-\w]+)/)?$', views.ProfileDetailView.as_view(), name='profiles-profile-detail'),

    url(r'^(?P<username>[-\w.-_@]+)/$', views.LegacyProfileDetailView.as_view(), name='profiles-profile-detail-legacy'),
