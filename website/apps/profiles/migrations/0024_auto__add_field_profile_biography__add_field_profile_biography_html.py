...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.biography'
        db.add_column('user_profiles', 'biography',
                      self.gf('lib.fields.extra.MarkdownTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.biography_html'
        db.add_column('user_profiles', 'biography_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.biography'
        db.delete_column('user_profiles', 'biography')

        # Deleting field 'Profile.biography_html'
        db.delete_column('user_profiles', 'biography_html')
