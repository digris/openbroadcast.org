    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('d_tags', tagging.fields.TagField(max_length=255, null=True, verbose_name='Tags', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pseudonym', models.CharField(help_text='Will appear instead of your first- & last name', max_length=250, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(help_text="URL with a single '{user}' placeholder to turn a username into a service URL.", verbose_name='url', blank=True)),
            ],
            options={
