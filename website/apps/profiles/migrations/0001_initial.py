    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django_extensions.db.fields.AutoSlugField(
                        editable=False, populate_from="name", blank=True, overwrite=True
                    ),
                ),
                ...
                (
                    "description",
                    base.fields.extra.MarkdownTextField(null=True, blank=True),
                ),
                (
                    "image",
                    models.ImageField(
                        upload_to=profiles.models.filename_by_uuid,
                        null=True,
                ...
                (
                    ...
                    phonenumber_field.modelfields.PhoneNumberField(
                        max_length=128, null=True, verbose_name="mobile", blank=True
                    ),
                ),
                (
                    "phone",
                ...
                (
                    "fax",
                    phonenumber_field.modelfields.PhoneNumberField(
                        max_length=128, null=True, verbose_name="fax", blank=True
                    ),
                ),
                ...
                (
                    "address1",
                    models.CharField(
                        max_length=100, null=True, verbose_name="address", blank=True
                    ),
                ),
                (
                    "address2",
                    models.CharField(
                        max_length=100,
                        null=True,
                        verbose_name="address (secondary)",
                        blank=True,
                    ),
                ),
                (
                    "city",
                    models.CharField(
                        max_length=100, null=True, verbose_name="city", blank=True
                    ),
                ),
                (
                    "zip",
                    models.CharField(
                        max_length=10, null=True, verbose_name="zip", blank=True
                    ),
                ),
                (
                    "d_tags",
                    tagging.fields.TagField(
                        max_length=255, null=True, verbose_name="Tags", blank=True
                    ),
                ),
                (
                    "country",
                    models.ForeignKey(blank=True, to="l10n.Country", null=True),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=100, null=True, verbose_name="title", blank=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "domain",
                    models.CharField(unique=True, max_length=50, verbose_name="domain"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iban",
                    models.CharField(
                        max_length=120, null=True, verbose_name="IBAN", blank=True
                    ),
                ),
                (
                    "paypal",
                    models.EmailField(
                        max_length=200, null=True, verbose_name="Paypal", blank=True
                    ),
                ),
                (
                    "d_tags",
                    tagging.fields.TagField(
                        max_length=1024, null=True, verbose_name="Tags", blank=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "username",
                    models.CharField(max_length=100, verbose_name="Userame / ID"),
                ),
                ("created", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=100, verbose_name="title", blank=True),
                ),
                (
                    "url",
                    models.URLField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="profiles.Expertise", verbose_name="Fields of expertise", blank=True
            ),
        ),
        migrations.AddField(
            model_name="community",
