...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('user_profiles', 'slug')

        # Adding field 'Profile.d_tags'
        db.add_column('user_profiles', 'd_tags',
    ...
    def backwards(self, orm):
        ...
        db.add_column('user_profiles', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(default='', populate_from='name', allow_duplicates=False, max_length=50, separator=u'-', blank=True, overwrite=True),
                      keep_default=False)

        # Deleting field 'Profile.d_tags'
        db.delete_column('user_profiles', 'd_tags')
