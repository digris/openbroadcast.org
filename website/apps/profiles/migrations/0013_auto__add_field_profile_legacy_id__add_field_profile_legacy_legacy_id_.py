...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.legacy_id'
        db.add_column('user_profiles', 'legacy_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.legacy_legacy_id'
        db.add_column('user_profiles', 'legacy_legacy_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.migrated'
        db.add_column('user_profiles', 'migrated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.legacy_id'
        db.delete_column('user_profiles', 'legacy_id')

        # Deleting field 'Profile.legacy_legacy_id'
        db.delete_column('user_profiles', 'legacy_legacy_id')

        # Deleting field 'Profile.migrated'
        db.delete_column('user_profiles', 'migrated')
