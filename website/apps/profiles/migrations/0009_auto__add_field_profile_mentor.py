...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.mentor'
        db.add_column('user_profiles', 'mentor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='godchildren', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.mentor'
        db.delete_column('user_profiles', 'mentor_id')
