...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.d_tags'
        db.alter_column('user_profiles', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.d_tags'
        db.alter_column('user_profiles', 'd_tags', self.gf('tagging.fields.TagField')(null=True))
