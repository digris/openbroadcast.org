...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.uuid'
        db.add_column('user_profiles', 'uuid',
        ...
        db.add_column('user_profiles', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='name', overwrite=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.uuid'
        db.delete_column('user_profiles', 'uuid')
