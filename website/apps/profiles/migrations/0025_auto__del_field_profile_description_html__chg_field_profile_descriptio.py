...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.description'
        db.alter_column('user_profiles', 'description', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.description'
        db.alter_column('user_profiles', 'description', self.gf('lib.fields.extra.MarkdownTextField')(null=True))
