...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.iban'
        db.alter_column('user_profiles', 'iban', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.iban'
        db.alter_column('user_profiles', 'iban', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
