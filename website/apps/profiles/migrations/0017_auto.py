...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field members on 'Community'
        db.create_table('profiles_community_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('community', models.ForeignKey(orm['profiles.community'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('profiles_community_members', ['community_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field members on 'Community'
        db.delete_table('profiles_community_members')
