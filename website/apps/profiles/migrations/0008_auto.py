...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('user_profiles_expertise', ['profile_id', 'expertise_id'])


    def backwards(self, orm):
        # Removing M2M table for field expertise on 'Profile'
        db.delete_table('user_profiles_expertise')
