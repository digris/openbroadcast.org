...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('user_profiles', 'state')

        # Adding field 'Profile.phone'
        db.add_column('user_profiles', 'phone',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.fax'
        db.add_column('user_profiles', 'fax',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.iban'
        db.add_column('user_profiles', 'iban',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.paypal'
        db.add_column('user_profiles', 'paypal',
                      self.gf('django.db.models.fields.EmailField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Profile.country'
        db.alter_column('user_profiles', 'country', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))

    def backwards(self, orm):
        # Adding field 'Profile.state'
        db.add_column('user_profiles', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.phone'
        db.delete_column('user_profiles', 'phone')

        # Deleting field 'Profile.fax'
        db.delete_column('user_profiles', 'fax')

        # Deleting field 'Profile.iban'
        db.delete_column('user_profiles', 'iban')

        # Deleting field 'Profile.paypal'
        db.delete_column('user_profiles', 'paypal')
    ...
    models = {
        ...
        'auth.group': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['auth.Group']"}),
