...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Community.group'
        db.delete_column('profiles_community', 'group_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Community.group'
        raise RuntimeError("Cannot reverse this migration. 'Community.group' and its values cannot be restored.")
