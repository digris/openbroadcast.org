...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('user_profiles', 'user_id')


    def backwards(self, orm):
        # Adding field 'Profile.user'
        db.add_column('user_profiles', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], unique=True),
                      keep_default=False)
