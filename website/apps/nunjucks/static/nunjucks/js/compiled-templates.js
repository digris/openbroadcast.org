...
try {
var parentTemplate = null;
output += "<div class=\"result-context\">\n\n    <ul class=\"keyboard-shortcuts\">\n\n        <li class=\"separator\">\n            <span class=\"help\">";
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["search/nj/result.default.html"] = (function() {
function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
var parentTemplate = null;
output += "<div class=\"item hoverable linkable\"\n    data-uuid=\"";
...
output += "\"\n    data-ct=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"ct"), env.opts.autoescape);
output += "\"\n    data-resource_uri=\"";
...
output += "\"\n    data-detail_uri=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"detail_uri"), env.opts.autoescape);
output += "\"\n    data-edit_uri=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"edit_uri"), env.opts.autoescape);
output += "\"\n    >\n    <div class=\"row-fluid\">\n\n        <div class=\"span2 result-image\">\n            <div>\n                ";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"image")) {
output += "\n                    <img src=\"/static/img/base/defaults/listview.release.xl.png\" data-src=\"";
...
output += "\n            </div>\n        </div>\n        <div class=\"span10 result-body\">\n\n            <div class=\"name\">\n                ";
if(!runtime.contextOrFrameLookup(context, frame, "is_single_ct")) {
output += "\n                    <small class=\"object-type\">";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"ct_display"), env.opts.autoescape);
output += "</small>\n                ";
;
}
output += "\n                <a href=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"detail_uri"), env.opts.autoescape);
output += "\" class=\"link-main\" title=\"";
...
output += "\">";
output += runtime.suppressValue(env.getFilter("shorten").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"name"),24), env.opts.autoescape);
output += "</a>\n            </div>\n\n            <div class=\"representation\">\n                ";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"representation"), env.opts.autoescape);
output += "\n            </div>\n\n            <div class=\"tags\">\n                ";
frame = frame.push();
...
if(!runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "folroop")),"last")) {
output += ", ";
;
}
output += "\n                ";
...
output += "</span><br />\n\n                    ";
if(runtime.memberLookup((t_4),"date_joined")) {
output += "\n                        <span>User since: ";
output += runtime.suppressValue(env.getFilter("format_datetime").call(context, runtime.memberLookup((t_4),"date_joined"),"date"), env.opts.autoescape);
output += "</span>\n                    ";
;
}
output += "\n\t\t\t\t</div>\n\n\t\t\t</div>\n\n\n\n\t\t</div>\n\t\t";
...
if(runtime.memberLookup((t_4),"release") && runtime.memberLookup((runtime.memberLookup((t_4),"release")),"main_image")) {
output += "\n                        <img src=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_4),"release")),"main_image"), env.opts.autoescape);
output += "\">\n                    ";
;
}
else {
...
output += "\n\n\n                                <li>\n                                    <span class=\"value\">\n                                        ";
if(runtime.memberLookup((t_4),"master_encoding")) {
output += "\n                                            ";
output += runtime.suppressValue(env.getFilter("upper").call(context, runtime.memberLookup((t_4),"master_encoding")), env.opts.autoescape);
output += " |\n                                        ";
;
}
output += "\n                                        ";
...
output += "\">-->\n\n                            <img src=\"/static/img/icons/loader/loader.96.222222.gif\" data-src=\"";
output += runtime.suppressValue(runtime.memberLookup((t_4),"thumb"), env.opts.autoescape);
output += "\" class=\"lazyload\" />\n\n                        ";
;
}
...
output += "\n\n                                ";
if(runtime.memberLookup((t_4),"aliases")) {
output += "\n                                    <li>\n                                        <span class=\"title\">\n                                            Aliases:\n                                        </span>\n                                        <span class=\"value\">\n                                            <strong>";
output += runtime.suppressValue(runtime.memberLookup((t_4),"aliases"), env.opts.autoescape);
output += "</strong>\n                                        </span>\n                                    </li>\n                                ";
;
}
output += "\n\n                                ";
if(runtime.memberLookup((t_4),"members")) {
output += "\n                                    <li>\n                                        <span class=\"title\">\n                                            Members:\n                                        </span>\n                                        <span class=\"value\">\n                                            <strong>";
output += runtime.suppressValue(runtime.memberLookup((t_4),"members"), env.opts.autoescape);
output += "</strong>\n                                        </span>\n                                    </li>\n                                ";
;
}
output += "\n\n                            ";
...
if(runtime.memberLookup((t_16),"label")) {
output += "\n                                        <span class=\"title\">\n                                            Label:\n                                        </span>\n                                        <span class=\"value\">\n                                            <strong>";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_16),"label")),"name"), env.opts.autoescape);
output += "</strong>\n                                        </span>\n                                        ";
;
}
output += "\n\n                                        ";
if(runtime.memberLookup((t_16),"catalog-number")) {
output += "\n                                        <span class=\"title\">\n                                            Catalog #:\n                                        </span>\n                                        <span class=\"value\">\n                                            <strong>";
...
output += "\n\n                            ";
if(runtime.memberLookup((t_4),"releases")) {
output += "\n                            <li>\n                            <span class=\"title\">\n                                Release:\n                            </span>\n                            <span class=\"value\">\n                                ";
frame = frame.push();
...
output += "\n                                    <strong>";
output += runtime.suppressValue(runtime.memberLookup((t_20),"title"), env.opts.autoescape);
output += "</strong>";
if(!runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "loop")),"last")) {
output += ", ";
;
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["aplayer/nj/popup_player_item.html"] = (function() {
function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
var parentTemplate = null;
output += "<div class=\"item playlist media ";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"uuid"), env.opts.autoescape);
output += " hoverable\" id=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"uuid"), env.opts.autoescape);
output += "\"\n     id=\"playlist_item_";
...
output += "</a> | <a class=\"parent_link\" href=\"";
...
output += runtime.suppressValue(env.getFilter("ms2time").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"duration")), env.opts.autoescape);
output += "\n                </span>\n            </div>\n            <div class=\"span1 actions\">\n                <span>\n                    <a data-action=\"collect\" href=\"#\"><i class=\"icon-plus icon-large\"></i></a>\n                </span>\n            </div>\n        </div>\n\n    </div>\n\n    <div class=\"indicator\">\n        <div class=\"wrapper\">\n            <div class=\"inner\">&nbsp;</div>\n        </div>\n    </div>\n</div>";
if(parentTemplate) {
parentTemplate.rootRenderFunc(env, context, frame, runtime, cb);
} else {
cb(null, output);
...
output += "\n    <small class=\"admin-info\" style=\"display: none;\"><a data-importfile_id=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"id"), env.opts.autoescape);
output += "\" href=\"#\">admin: ";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"id"), env.opts.autoescape);
output += "</a></small>\n    ";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"status") == "duplicate") {
output += "<span class=\"warning pull-right\">Possible Duplicate</span>";
;
}
output += "\n\n    ";
...
output += "\n                ";
if(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"import_tag")),"alibrary_release_matches")) {
output += "\n                    <a href=\"#\" class=\"matches\"><i class=\"icon-warning-sign\"></i> ";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"import_tag")),"alibrary_release_matches"), env.opts.autoescape);
output += " matches</a>\n                ";
;
}
...
output += "\n        </div>\n\n        <div class=\"span2\">\n            <a class=\"btn btn-mini btn-primary pull-right apply-to-all\" data-ct=\"release\"><i class=\"icon-repeat\"></i> Apply Release\n                to all</a>\n        </div>\n\n\n    </div>\n\n    <!-- artist -->\n    <div class=\"row-fluid base artist ";
...
if(runtime.memberLookup((t_4),"ct") == "alibrary.artist") {
output += "\n                            <li>\n                                <strong>";
output += runtime.suppressValue(runtime.memberLookup((t_4),"name"), env.opts.autoescape);
output += "</strong>\n                                ";
if(runtime.memberLookup((t_4),"country")) {
...
output += "\n\n                            ";
if(runtime.memberLookup((t_4),"year_start") || runtime.memberLookup((t_4),"year_end")) {
output += "\n                            <li>\n                                <span class=\"value\">\n                                    ";
if(runtime.memberLookup((t_4),"year_start")) {
output += "*";
output += runtime.suppressValue(runtime.memberLookup((t_4),"year_start"), env.opts.autoescape);
;
}
output += " ";
if(runtime.memberLookup((t_4),"year_end")) {
output += "✝";
output += runtime.suppressValue(runtime.memberLookup((t_4),"year_end"), env.opts.autoescape);
;
}
output += "\n                                </span>\n                            </li>\n                            ";
;
...
output += "\n\n                        ";
if(runtime.memberLookup((t_4),"ct") == "alibrary.release") {
output += "\n                            <li>\n                                <strong>";
output += runtime.suppressValue(runtime.memberLookup((t_4),"name"), env.opts.autoescape);
output += "</strong>\n                                ";
if(runtime.memberLookup((t_4),"country")) {
...
output += "\n                                ";
if(runtime.memberLookup((t_4),"releasedate")) {
output += "\n                                    <small class=\"pull-right\">";
output += runtime.suppressValue(runtime.memberLookup((t_4),"releasedate"), env.opts.autoescape);
output += "</small>\n                                ";
;
...
output += "\n           ></i>\n\n    </td>\n\n\n    <td>\n        ";
output += runtime.suppressValue(env.getFilter("truncate_chars_inner").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"filename"),64), env.opts.autoescape);
output += " <small>debug: ";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"id"), env.opts.autoescape);
output += "</small>\n\n    </td>\n    <td>";
