...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playout.analyzer_data'
        db.add_column('bcmon_playout', 'analyzer_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playout.analyzer_data'
        db.delete_column('bcmon_playout', 'analyzer_data')
    ...
    models = {
        ...
        'bcmon.playout': {
            ...
            'analyzer_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
