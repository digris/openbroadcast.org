...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChannelPlugin'
        db.create_table('cmsplugin_channelplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['bcmon.Channel'])),
        ))
        db.send_create_signal('bcmon', ['ChannelPlugin'])


    def backwards(self, orm):
        # Deleting model 'ChannelPlugin'
        db.delete_table('cmsplugin_channelplugin')
