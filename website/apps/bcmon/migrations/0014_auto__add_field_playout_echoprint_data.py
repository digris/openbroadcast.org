...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playout.echoprint_data'
        db.add_column('bcmon_playout', 'echoprint_data',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playout.echoprint_data'
        db.delete_column('bcmon_playout', 'echoprint_data')
