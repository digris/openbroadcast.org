...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.enable_monitoring'
        db.add_column('bcmon_channel', 'enable_monitoring',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.enable_monitoring'
        db.delete_column('bcmon_channel', 'enable_monitoring')
