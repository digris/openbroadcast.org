...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playout.time_start'
        db.add_column('bcmon_playout', 'time_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Playout.time_end'
        db.add_column('bcmon_playout', 'time_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playout.time_start'
        db.delete_column('bcmon_playout', 'time_start')

        # Deleting field 'Playout.time_end'
        db.delete_column('bcmon_playout', 'time_end')
