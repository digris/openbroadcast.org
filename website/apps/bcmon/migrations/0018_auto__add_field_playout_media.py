...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playout.media'
        db.add_column('bcmon_playout', 'media',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Media'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playout.media'
        db.delete_column('bcmon_playout', 'media_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c0c5d194-1997-44fb-bc54-4b74db4baf53'", 'max_length': '36'})
        },
        'alibrary.media': {
        ...
        'bcmon.playout': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alibrary.Media']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
