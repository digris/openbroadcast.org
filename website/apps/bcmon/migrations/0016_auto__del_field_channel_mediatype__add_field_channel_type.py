...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Channel.mediatype'
        db.delete_column('bcmon_channel', 'mediatype')

        # Adding field 'Channel.type'
        db.add_column('bcmon_channel', 'type',
                      self.gf('django.db.models.fields.CharField')(default='stream', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Channel.mediatype'
        db.add_column('bcmon_channel', 'mediatype',
                      self.gf('django.db.models.fields.CharField')(default='stream', max_length=12),
                      keep_default=False)

        # Deleting field 'Channel.type'
        db.delete_column('bcmon_channel', 'type')
