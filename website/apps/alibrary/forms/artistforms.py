    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            self.fields["namevariations"].initial = ", ".join(
                self.instance.namevariations.values_list("name", flat=True).distinct()
            )
...
class BaseMemberFormSet(BaseInlineFormSet):
    def __init__(self, *args, **kwargs):
        ...
        base_layout = Row(
            Column(Field("child", css_class="input-xlarge"), css_class="span8"),
...
class BaseArtistReleationFormSet(BaseGenericInlineFormSet):
    def __init__(self, *args, **kwargs):
        ...
        base_layout = Row(
            Column(
                Field("url", css_class="input-xlarge"), css_class="span8 relation-url"
            ),
            Column(Field("service", css_class="input-mini"), css_class="span2"),
