...
class PlaylistItemResource(ModelResource):
    co_to = {Release: ReleaseResource, Media: SimpleMediaResource}
...
class PlaylistItemPlaylistResource(ModelResource):
    item = fields.ToOneField(
        "alibrary.api.PlaylistItemResource", "item", null=True, full=True
    )
...
class PlaylistResource(ModelResource):
    ...
    def set_current(self, request, **kwargs):
        ...
        Playlist.objects.filter(user=request.user).exclude(
