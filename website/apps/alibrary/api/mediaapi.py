...
class MediaResource(ModelResource):
    ...
    def dehydrate(self, bundle):
        ...
        bundle.data["waveform_image"] = reverse_lazy(
            "mediaasset-waveform", kwargs={"media_uuid": bundle.obj.uuid, "type": "w"}
        )
        bundle.data["spectrogram_image"] = reverse_lazy(
            "mediaasset-waveform", kwargs={"media_uuid": bundle.obj.uuid, "type": "s"}
        )
