...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Label.type'
        db.alter_column('alibrary_label', 'type', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Media.mediatype'
        db.alter_column('alibrary_media', 'mediatype', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Artist.type'
        db.alter_column('alibrary_artist', 'type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Label.type'
        db.alter_column('alibrary_label', 'type', self.gf('django.db.models.fields.CharField')(max_length=12))

        # Changing field 'Media.mediatype'
        db.alter_column('alibrary_media', 'mediatype', self.gf('django.db.models.fields.CharField')(max_length=12))

        # Changing field 'Artist.type'
        db.alter_column('alibrary_artist', 'type', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'name'", 'overwrite': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '128'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3e1502bc-1d1e-4255-9c3d-d37a733ef7f3'", 'max_length': '36'}),
        ...
        'alibrary.media': {
            'Meta': {'ordering': "('medianumber', 'tracknumber', 'name')", 'object_name': 'Media'},
            ...
            'media_artists': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'credited'", 'to': "orm['alibrary.Artist']", 'through': "orm['alibrary.MediaArtists']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'medianumber': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'mediatype': ('django.db.models.fields.CharField', [], {'default': "'song'", 'max_length': '128'}),
            'migrated': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'alibrary.mediaartists': {
            'Meta': {'ordering': "('position',)", 'object_name': 'MediaArtists'},
            'artist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'artist_mediaartist'", 'to': "orm['alibrary.Artist']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_phrase': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'media': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'media_mediaartist'", 'to': "orm['alibrary.Media']"}),
        ...
        'l10n.country': {
            'Meta': {'ordering': "('printable_name',)", 'object_name': 'Country'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
