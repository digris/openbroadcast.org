...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DistributorLabel'
        db.create_table('alibrary_distributorlabel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('distributor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Distributor'])),
            ('label', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Label'])),
            ('exclusive', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('alibrary', ['DistributorLabel'])


    def backwards(self, orm):
        # Deleting model 'DistributorLabel'
        db.delete_table('alibrary_distributorlabel')
    ...
    models = {
        ...
        'alibrary.distributor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'labels': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'labels'", 'to': "orm['alibrary.Label']", 'through': "orm['alibrary.DistributorLabel']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'legacy_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4ed4ea55-1d52-426f-95b9-555c99e65c38'", 'max_length': '36'})
        },
