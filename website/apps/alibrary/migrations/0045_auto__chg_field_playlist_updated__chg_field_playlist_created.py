...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Playlist.updated'
        db.alter_column('alibrary_playlist', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Playlist.created'
        db.alter_column('alibrary_playlist', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Playlist.updated'
        db.alter_column('alibrary_playlist', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Playlist.created'
        db.alter_column('alibrary_playlist', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2bd36657-a750-472a-abfe-ab55ba963c01'", 'max_length': '36'})
        },
