...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.d_tags'
        db.add_column('alibrary_media', 'd_tags',
                      self.gf('tagging.fields.TagField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.d_tags'
        db.delete_column('alibrary_media', 'd_tags')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8e44bef5-6d79-481c-bf43-4b7909f803d3'", 'max_length': '36'})
        },
