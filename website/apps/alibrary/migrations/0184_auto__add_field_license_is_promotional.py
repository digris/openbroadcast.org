...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.is_promotional'
        db.add_column('alibrary_license', 'is_promotional',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'License.is_promotional'
        db.delete_column('alibrary_license', 'is_promotional')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'87706f33-29fc-402e-8435-3990fb961a17'", 'max_length': '36'}),
