...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.barcode'
        db.add_column('alibrary_release', 'barcode',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.barcode'
        db.delete_column('alibrary_release', 'barcode')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'de4e541e-d810-408b-b021-27b7f6984fa1'", 'max_length': '36'})
        },
