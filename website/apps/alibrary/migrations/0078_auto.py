...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field seasons on 'Playlist'
        db.create_table('alibrary_playlist_seasons', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playlist', models.ForeignKey(orm['alibrary.playlist'], null=False)),
            ('season', models.ForeignKey(orm['alibrary.season'], null=False))
        ))
        db.create_unique('alibrary_playlist_seasons', ['playlist_id', 'season_id'])

        # Adding M2M table for field weather on 'Playlist'
        db.create_table('alibrary_playlist_weather', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playlist', models.ForeignKey(orm['alibrary.playlist'], null=False)),
            ('weather', models.ForeignKey(orm['alibrary.weather'], null=False))
        ))
        db.create_unique('alibrary_playlist_weather', ['playlist_id', 'weather_id'])


    def backwards(self, orm):
        # Removing M2M table for field seasons on 'Playlist'
        db.delete_table('alibrary_playlist_seasons')

        # Removing M2M table for field weather on 'Playlist'
        db.delete_table('alibrary_playlist_weather')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ac0ffa32-5deb-4fc4-9438-741895a29e72'", 'max_length': '36'})
        },
