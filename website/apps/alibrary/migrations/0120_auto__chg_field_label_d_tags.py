...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Label.d_tags'
        db.alter_column('alibrary_label', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Label.d_tags'
        db.alter_column('alibrary_label', 'd_tags', self.gf('tagging.fields.TagField')(null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a66668d0-2a8b-4229-9c05-ffec7ecde99c'", 'max_length': '36'})
        },
