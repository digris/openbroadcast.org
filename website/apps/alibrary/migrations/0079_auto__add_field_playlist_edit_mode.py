...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.edit_mode'
        db.add_column('alibrary_playlist', 'edit_mode',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.edit_mode'
        db.delete_column('alibrary_playlist', 'edit_mode')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dee81ca1-7b43-40d1-828c-12f9298cacaf'", 'max_length': '36'})
        },
