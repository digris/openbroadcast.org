...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Release.placeholder_1'
        db.delete_column('alibrary_release', 'placeholder_1_id')


    def backwards(self, orm):
        # Adding field 'Release.placeholder_1'
        db.add_column('alibrary_release', 'placeholder_1',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3a2d0e24-2362-4692-8133-545d8f2abcfd'", 'max_length': '36'})
        },
