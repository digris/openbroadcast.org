...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Media', fields ['name']
        db.create_index('alibrary_media', ['name'])

        # Adding index on 'Artist', fields ['name']
        db.create_index('alibrary_artist', ['name'])


    def backwards(self, orm):
        # Removing index on 'Artist', fields ['name']
        db.delete_index('alibrary_artist', ['name'])

        # Removing index on 'Media', fields ['name']
        db.delete_index('alibrary_media', ['name'])
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'17dd1a2a-8abb-488c-9f40-35cae291dce0'", 'max_length': '36'})
        },
        'alibrary.media': {
