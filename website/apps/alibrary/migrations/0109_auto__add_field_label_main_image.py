...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alibrary_label', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='label_main_image', null=True, to=orm['filer.Image']),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'efecf40a-b7ae-4985-847d-80d8459e0144'", 'max_length': '36'})
        },
