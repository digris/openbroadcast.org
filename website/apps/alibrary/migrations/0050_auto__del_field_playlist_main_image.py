...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('alibrary_playlist', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='playlist_main_image', null=True, to=orm['filer.Image'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a4219711-03c3-4a29-a010-7e093eb1ffcf'", 'max_length': '36'})
        },
