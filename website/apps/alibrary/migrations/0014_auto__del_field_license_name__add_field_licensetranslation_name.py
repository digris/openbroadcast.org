...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alibrary_license', 'name')

        # Adding field 'LicenseTranslation.name'
        db.add_column('alibrary_license_translation', 'name',
                      self.gf('django.db.models.fields.CharField')(default='new-name', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'License.name'
        db.add_column('alibrary_license', 'name',
                      self.gf('django.db.models.fields.CharField')(default='changed', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c4f2091f-d674-4418-a84d-14ed397666f2'", 'max_length': '36'})
        },
