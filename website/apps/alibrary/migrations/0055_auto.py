...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field dayparts on 'Playlist'
        db.create_table('alibrary_playlist_dayparts', (
        ...
        db.create_unique('alibrary_playlist_dayparts', ['playlist_id', 'daypart_id'])


    def backwards(self, orm):
        # Removing M2M table for field dayparts on 'Playlist'
        db.delete_table('alibrary_playlist_dayparts')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'885e59e9-d51c-4e41-9229-31b721524718'", 'max_length': '36'})
        },
        ...
        'alibrary.playlist': {
            ...
            'dayparts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['alibrary.Daypart']", 'null': 'True', 'blank': 'True'}),
