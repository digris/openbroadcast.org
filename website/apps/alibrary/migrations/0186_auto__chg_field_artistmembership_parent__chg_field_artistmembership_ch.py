...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArtistMembership.parent'
        db.alter_column('alibrary_artistmembership', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alibrary.Artist']))

        # Changing field 'ArtistMembership.child'
        db.alter_column('alibrary_artistmembership', 'child_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alibrary.Artist']))

    def backwards(self, orm):

        # Changing field 'ArtistMembership.parent'
        db.alter_column('alibrary_artistmembership', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['alibrary.Artist']))

        # Changing field 'ArtistMembership.child'
        db.alter_column('alibrary_artistmembership', 'child_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['alibrary.Artist']))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fd5e803e-68a6-42c8-9096-3b9d46bef566'", 'max_length': '36'}),
