...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Relation', fields ['object_id', 'content_type']
        db.create_unique('alibrary_relation', ['object_id', 'content_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Relation', fields ['object_id', 'content_type']
        db.delete_unique('alibrary_relation', ['object_id', 'content_type_id'])
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7cab3808-ff8b-48a6-9704-b0eaef184c39'", 'max_length': '36'})
        },
        ...
        'alibrary.relation': {
            'Meta': {'ordering': "('url',)", 'unique_together': "(('content_type', 'object_id'),)", 'object_name': 'Relation'},
