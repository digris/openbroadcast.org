...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.description'
        db.add_column('alibrary_playlist', 'description',
                      self.gf('lib.fields.extra.MarkdownTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Playlist.description_html'
        db.add_column('alibrary_playlist', 'description_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.description'
        db.delete_column('alibrary_playlist', 'description')

        # Deleting field 'Playlist.description_html'
        db.delete_column('alibrary_playlist', 'description_html')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'44a4727b-dd79-45f5-8d4b-36d4dd2e32bb'", 'max_length': '36'})
        },
