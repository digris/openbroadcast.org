...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Series'
        db.create_table('alibrary_series', (
        ...
        db.send_create_signal('alibrary', ['Series'])

        # Adding field 'Playlist.series'
        db.add_column('alibrary_playlist', 'series',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Series'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Playlist.series_number'
        db.add_column('alibrary_playlist', 'series_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Artist.placeholder_1'
        db.delete_column('alibrary_artist', 'placeholder_1_id')


    def backwards(self, orm):
        # Deleting model 'Series'
        db.delete_table('alibrary_series')

        # Deleting field 'Playlist.series'
        db.delete_column('alibrary_playlist', 'series_id')

        # Deleting field 'Playlist.series_number'
        db.delete_column('alibrary_playlist', 'series_number')

        # Adding field 'Artist.placeholder_1'
        db.add_column('alibrary_artist', 'placeholder_1',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7dadc38a-698b-46fa-ad15-3e6ef6041f82'", 'max_length': '36'})
        },
