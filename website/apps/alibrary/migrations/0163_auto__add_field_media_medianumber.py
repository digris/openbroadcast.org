...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.medianumber'
        db.add_column('alibrary_media', 'medianumber',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.medianumber'
        db.delete_column('alibrary_media', 'medianumber')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d67c54cc-1749-420d-b2ab-da6623afa78d'", 'max_length': '36'})
        },
