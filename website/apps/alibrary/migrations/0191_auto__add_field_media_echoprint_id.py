...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.echoprint_id'
        db.add_column('alibrary_media', 'echoprint_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.echoprint_id'
        db.delete_column('alibrary_media', 'echoprint_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fd64d92c-33b8-450d-884c-6b17cd81faaa'", 'max_length': '36'}),
        ...
        'alibrary.media': {
            ...
            'echoprint_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
