...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaylistMedia.updated'
        db.add_column('alibrary_playlistmedia', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PlaylistItemPlaylist.updated'
        db.add_column('alibrary_playlistitemplaylist', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaylistMedia.updated'
        db.delete_column('alibrary_playlistmedia', 'updated')

        # Deleting field 'PlaylistItemPlaylist.updated'
        db.delete_column('alibrary_playlistitemplaylist', 'updated')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0e68f7f0-aa2a-40b5-8539-ff3c67e09c73'", 'max_length': '36'})
        },
