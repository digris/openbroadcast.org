...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Label.email_main'
        db.delete_column('alibrary_label', 'email_main')

        # Adding field 'Label.country_b'
        db.add_column('alibrary_label', 'country_b',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['l10n.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.email'
        db.add_column('alibrary_label', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.phone'
        db.add_column('alibrary_label', 'phone',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.fax'
        db.add_column('alibrary_label', 'fax',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Label.email_main'
        db.add_column('alibrary_label', 'email_main',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Label.country_b'
        db.delete_column('alibrary_label', 'country_b_id')

        # Deleting field 'Label.email'
        db.delete_column('alibrary_label', 'email')

        # Deleting field 'Label.phone'
        db.delete_column('alibrary_label', 'phone')

        # Deleting field 'Label.fax'
        db.delete_column('alibrary_label', 'fax')
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'country_b': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['l10n.Country']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ac520c03-418a-45f4-9ccc-f0099db80586'", 'max_length': '36'})
        },
