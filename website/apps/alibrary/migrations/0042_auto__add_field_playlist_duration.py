...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alibrary_playlist', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=12, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.duration'
        db.delete_column('alibrary_playlist', 'duration')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e6d67b2c-82a7-45cd-b558-411eac15fe33'", 'max_length': '36'})
        },
