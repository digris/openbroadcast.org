...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'License.is_default'
        db.alter_column('alibrary_license', 'is_default', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'License.selectable'
        db.alter_column('alibrary_license', 'selectable', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'License.is_default'
        db.alter_column('alibrary_license', 'is_default', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'License.selectable'
        db.alter_column('alibrary_license', 'selectable', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'selectable': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'abdd34c4-a70c-4a76-a121-332cc0231bf7'", 'max_length': '36'})
        },
