...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.danceability'
        db.add_column('alibrary_media', 'danceability',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.danceability'
        db.delete_column('alibrary_media', 'danceability')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'83c470db-49d3-4fc8-940d-6492e216f1ca'", 'max_length': '36'})
        },
