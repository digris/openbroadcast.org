...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relation.object_id'
        db.alter_column('alibrary_relation', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding unique constraint on 'Relation', fields ['content_type', 'service', 'object_id']
        db.create_unique('alibrary_relation', ['content_type_id', 'service', 'object_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Relation', fields ['content_type', 'service', 'object_id']
        db.delete_unique('alibrary_relation', ['content_type_id', 'service', 'object_id'])


        # Changing field 'Relation.object_id'
        db.alter_column('alibrary_relation', 'object_id', self.gf('django.db.models.fields.CharField')(max_length=36))

        # Changing field 'Release.d_tags'
        db.alter_column('alibrary_release', 'd_tags', self.gf('tagging.fields.TagField')(default=''))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e9aa4f82-44ea-4886-867a-7ca46c5412ce'", 'max_length': '36'})
        },
