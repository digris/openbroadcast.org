...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.d_tags'
        db.add_column('alibrary_label', 'd_tags',
                      self.gf('tagging.fields.TagField')(null=True),
                      keep_default=False)

        # Adding field 'Artist.d_tags'
        db.add_column('alibrary_artist', 'd_tags',
                      self.gf('tagging.fields.TagField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.d_tags'
        db.delete_column('alibrary_label', 'd_tags')

        # Deleting field 'Artist.d_tags'
        db.delete_column('alibrary_artist', 'd_tags')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'10002776-9b90-4af1-863c-307e214dc05b'", 'max_length': '36'})
        },
