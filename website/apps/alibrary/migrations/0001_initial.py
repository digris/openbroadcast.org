...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Label'
        db.create_table('alibrary_label', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='label_children', null=True, to=orm['alibrary.Label'])),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='label_folder', null=True, to=orm['filer.Folder'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('alibrary', ['Label'])

        # Adding model 'License'
        db.create_table('alibrary_license', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='e1437c3f-d871-4da8-8cca-03b903fb9016', max_length=36)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('restricted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ...
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='license_children', null=True, to=orm['alibrary.License'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('alibrary', ['License'])

        # Adding model 'Profession'
        db.create_table('alibrary_profession', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('in_listing', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('excerpt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Profession'])

        # Adding model 'Mediaformat'
        db.create_table('alibrary_mediaformat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('excerpt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('in_listing', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('alibrary', ['Mediaformat'])

        # Adding model 'Relation'
        db.create_table('alibrary_relation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('service', self.gf('django.db.models.fields.CharField')(default='generic', max_length=50)),
            ('action', self.gf('django.db.models.fields.CharField')(default='information', max_length=50)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Relation'])

        # Adding model 'Playlist'
        db.create_table('alibrary_playlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('playlisttype', self.gf('django.db.models.fields.CharField')(default='other', max_length=12)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Playlist'])

        # Adding model 'PlaylistMedia'
        db.create_table('alibrary_playlistmedia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('playlist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playlist_playlist', to=orm['alibrary.Playlist'])),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playlist_media', to=orm['alibrary.Media'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
        ))
        db.send_create_signal('alibrary', ['PlaylistMedia'])

        # Adding model 'Media'
        db.create_table('alibrary_media', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('legacy_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('migrated', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='name', overwrite=True)),
            ('isrc', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('master_path', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True)),
            ...
            ('tracknumber', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
            ('mediatype', self.gf('django.db.models.fields.CharField')(default='track', max_length=12)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('duration', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12, null=True, blank=True)),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_release', null=True, on_delete=models.SET_NULL, to=orm['alibrary.Release'])),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_artist', null=True, to=orm['alibrary.Artist'])),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_folder', null=True, on_delete=models.SET_NULL, to=orm['filer.Folder'])),
            ('license', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_license', null=True, to=orm['alibrary.License'])),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_master', null=True, to=orm['filer.Audio'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Media'])

        # Adding model 'MediaExtraartists'
        db.create_table('alibrary_mediaextraartists', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extraartist_artist', to=orm['alibrary.Artist'])),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extraartist_media', to=orm['alibrary.Media'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_extraartist_profession', null=True, to=orm['alibrary.Profession'])),
        ))
        db.send_create_signal('alibrary', ['MediaExtraartists'])

        # Adding model 'MediaPlugin'
        db.create_table('cmsplugin_mediaplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Media'])),
            ('headline', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('alibrary', ['MediaPlugin'])

        # Adding model 'Release'
        db.create_table('alibrary_release', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('legacy_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('migrated', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='name', overwrite=True)),
            ('release_country', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_main_image', null=True, to=orm['filer.Image'])),
            ('cover_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_cover_image', null=True, to=orm['filer.Image'])),
            ('catalognumber', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
            ('main_format', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Mediaformat'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('excerpt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('label', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_label', null=True, on_delete=models.SET_NULL, to=orm['alibrary.Label'])),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_folder', null=True, on_delete=models.SET_NULL, to=orm['filer.Folder'])),
            ('enable_comments', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Release'])

        # Adding model 'ReleaseExtraartists'
        db.create_table('alibrary_releaseextraartists', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_extraartist_artist', to=orm['alibrary.Artist'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_extraartist_release', to=orm['alibrary.Release'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_extraartist_profession', null=True, to=orm['alibrary.Profession'])),
        ))
        db.send_create_signal('alibrary', ['ReleaseExtraartists'])

        # Adding model 'ReleaseRelations'
        db.create_table('alibrary_releaserelations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('relation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_relation_relation', to=orm['alibrary.Relation'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_relation_release', to=orm['alibrary.Release'])),
        ))
        db.send_create_signal('alibrary', ['ReleaseRelations'])

        # Adding model 'ReleasePlugin'
        db.create_table('cmsplugin_releaseplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Release'])),
        ))
        db.send_create_signal('alibrary', ['ReleasePlugin'])

        # Adding model 'Artist'
        db.create_table('alibrary_artist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('legacy_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('migrated', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='name', overwrite=True)),
            ('main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artist_main_image', null=True, to=orm['filer.Image'])),
            ('real_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('placeholder_1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True)),
            ('listed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('disable_link', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('excerpt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('biography', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artist_folder', null=True, on_delete=models.SET_NULL, to=orm['filer.Folder'])),
            ('enable_comments', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Artist'])

        # Adding M2M table for field aliases on 'Artist'
        db.create_table('alibrary_artist_aliases', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_artist', models.ForeignKey(orm['alibrary.artist'], null=False)),
            ('to_artist', models.ForeignKey(orm['alibrary.artist'], null=False))
        ))
        db.create_unique('alibrary_artist_aliases', ['from_artist_id', 'to_artist_id'])

        # Adding model 'ArtistMembership'
        db.create_table('alibrary_artistmembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='artist_parent', to=orm['alibrary.Artist'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='artist_child', to=orm['alibrary.Artist'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artist_membership_profession', null=True, to=orm['alibrary.Profession'])),
        ))
        db.send_create_signal('alibrary', ['ArtistMembership'])

        # Adding model 'ArtistProfessions'
        db.create_table('alibrary_artistprofessions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Artist'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Profession'])),
        ))
        db.send_create_signal('alibrary', ['ArtistProfessions'])

        # Adding model 'ArtistPlugin'
        db.create_table('cmsplugin_artistplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Artist'])),
        ))
        db.send_create_signal('alibrary', ['ArtistPlugin'])

        # Adding model 'Format'
        db.create_table('alibrary_format', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('default_price', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=6, null=True, blank=True)),
            ('version', self.gf('django.db.models.fields.CharField')(default='base', max_length=10)),
            ('excerpt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['Format'])


    def backwards(self, orm):
        # Deleting model 'Label'
        db.delete_table('alibrary_label')

        # Deleting model 'License'
        db.delete_table('alibrary_license')

        # Deleting model 'Profession'
        db.delete_table('alibrary_profession')

        # Deleting model 'Mediaformat'
        db.delete_table('alibrary_mediaformat')

        # Deleting model 'Relation'
        db.delete_table('alibrary_relation')

        # Deleting model 'Playlist'
        db.delete_table('alibrary_playlist')

        # Deleting model 'PlaylistMedia'
        db.delete_table('alibrary_playlistmedia')

        # Deleting model 'Media'
        db.delete_table('alibrary_media')

        # Deleting model 'MediaExtraartists'
        db.delete_table('alibrary_mediaextraartists')

        # Deleting model 'MediaPlugin'
        db.delete_table('cmsplugin_mediaplugin')

        # Deleting model 'Release'
        db.delete_table('alibrary_release')

        # Deleting model 'ReleaseExtraartists'
        db.delete_table('alibrary_releaseextraartists')

        # Deleting model 'ReleaseRelations'
        db.delete_table('alibrary_releaserelations')

        # Deleting model 'ReleasePlugin'
        db.delete_table('cmsplugin_releaseplugin')

        # Deleting model 'Artist'
        db.delete_table('alibrary_artist')

        # Removing M2M table for field aliases on 'Artist'
        db.delete_table('alibrary_artist_aliases')

        # Deleting model 'ArtistMembership'
        db.delete_table('alibrary_artistmembership')

        # Deleting model 'ArtistProfessions'
        db.delete_table('alibrary_artistprofessions')

        # Deleting model 'ArtistPlugin'
        db.delete_table('cmsplugin_artistplugin')

        # Deleting model 'Format'
        db.delete_table('alibrary_format')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e1437c3f-d871-4da8-8cca-03b903fb9016'", 'max_length': '36'})
        },
        'alibrary.media': {
