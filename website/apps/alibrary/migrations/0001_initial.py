    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(to='alibrary.Agency')),
            ],
            options={
                'verbose_name': 'Managing',
                'verbose_name_plural': 'Managing',
            },
        ),
        migrations.CreateModel(
            name='AgencyScope',
            ...
            options={
                'verbose_name': 'Scope (Agency)',
                'verbose_name_plural': 'Scopes (Agency)',
            },
        ),
        migrations.CreateModel(
            name='APILookup',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('provider', models.CharField(default=None, max_length=50, choices=[(None, 'Not Set'), (b'discogs', 'Discogs'), (b'musicbrainz', 'Musicbrainz')])),
                ('uri', models.URLField(null=True, blank=True)),
                ('ressource_id', models.CharField(max_length=500, null=True, blank=True)),
                ('api_data', django_extensions.db.fields.json.JSONField(null=True, blank=True)),
            ...
            options={
                'ordering': ('created',),
                'verbose_name': 'APILookup',
                'verbose_name_plural': 'APILookups',
            },
        ),
        migrations.CreateModel(
            name='Artist',
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(editable=False, populate_from=b'name', blank=True, overwrite=True)),
                ('type', models.CharField(blank=True, max_length=128, null=True, verbose_name=b'Artist type', choices=[(b'person', 'Person'), (b'group', 'Group'), (b'orchestra', 'Orchestra'), (b'other', 'Other')])),
                ...
                ('date_start', django_date_extensions.fields.ApproximateDateField(help_text='date of formation / date of birth', max_length=10, null=True, verbose_name='Begin', blank=True)),
                ('date_end', django_date_extensions.fields.ApproximateDateField(help_text='date of breakup / date of death', max_length=10, null=True, verbose_name='End', blank=True)),
                ('listed', models.BooleanField(default=True, help_text='Should this Artist be shown on the default Artist-list?', verbose_name=b'Include in listings')),
                ('disable_link', models.BooleanField(default=False, help_text='Disable Linking. Useful e.g. for "Varius Artists"', verbose_name=b'Disable Link')),
                ('disable_editing', models.BooleanField(default=False, help_text='Disable Editing. Useful e.g. for "Unknown Artist"', verbose_name=b'Disable Editing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='distributors_creator', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('first_placeholder', cms.models.fields.PlaceholderField(slotname=b'first_placeholder', editable=False, to='cms.Placeholder', null=True)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('format', models.CharField(max_length=4, choices=[(b'mp3', 'MP3'), (b'flac', 'Flac'), (b'wav', 'WAV'), (b'aiff', 'AIFF')])),
                ('default_price', models.PositiveIntegerField(default=1, null=True, blank=True)),
                ('version', models.CharField(default=b'base', max_length=10, choices=[(b'base', 'Base')])),
                ('excerpt', models.TextField(null=True, verbose_name='Notes', blank=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end', django_date_extensions.fields.ApproximateDateField(max_length=10, null=True, verbose_name=b'Life-span end', blank=True)),
                ('listed', models.BooleanField(default=True, help_text='Should this Label be shown on the default Label-list?', verbose_name=b'Include in listings')),
                ('disable_link', models.BooleanField(default=False, help_text='Disable Linking. Useful e.g. for "Unknown Label"', verbose_name=b'Disable Link')),
                ('disable_editing', models.BooleanField(default=False, help_text='Disable Editing. Useful e.g. for "Unknown Label"', verbose_name=b'Disable Editing')),
                ('type', models.CharField(default=b'unknown', max_length=128, verbose_name=b'Label type', choices=[(b'unknown', 'Unknown'), (b'major', 'Major Label'), (b'indy', 'Independent Label'), (b'net', 'Netlabel'), (b'event', 'Event Label')])),
                ('d_tags', tagging.fields.TagField(max_length=1024, null=True, verbose_name=b'Tags', blank=True)),
                ('description_html', models.TextField(null=True, editable=False, blank=True)),
                ('lft', models.PositiveIntegerField(editable=False, db_index=True)),
                ('rght', models.PositiveIntegerField(editable=False, db_index=True)),
                ...
                ('folder', models.ForeignKey(related_name='label_folder', blank=True, to='filer.Folder', null=True)),
                ...
                ('parent', mptt.fields.TreeForeignKey(related_name='label_children', blank=True, to='alibrary.Label', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(default=b'ab833318-191a-4bf9-8609-c449d5ad3ec4', max_length=36, editable=False)),
                ...
                ('tree_id', models.PositiveIntegerField(editable=False, db_index=True)),
                ('level', models.PositiveIntegerField(editable=False, db_index=True)),
                ('parent', mptt.fields.TreeForeignKey(related_name='license_children', blank=True, to='alibrary.License', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='alibrary.License', null=True)),
            ],
            options={
                'managed': True,
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processed', models.PositiveIntegerField(default=0, choices=[(0, 'Waiting'), (1, 'Done'), (99, 'Error')])),
                ('echoprint_status', models.PositiveIntegerField(default=0, choices=[(0, 'Init'), (1, 'Assigned'), (2, 'Error'), (3, 'File not suitable'), (99, 'Error')])),
                ('conversion_status', models.PositiveIntegerField(default=0, choices=[(0, 'Init'), (1, 'Completed'), (2, 'Error'), (99, 'Error')])),
                ...
                ('base_format', models.CharField(max_length=12, null=True, verbose_name='Format', blank=True)),
                ('base_filesize', models.PositiveIntegerField(null=True, verbose_name='Filesize', blank=True)),
                ('base_duration', models.FloatField(null=True, verbose_name='Duration', blank=True)),
                ('base_samplerate', models.PositiveIntegerField(null=True, verbose_name='Samplerate', blank=True)),
                ('base_bitrate', models.PositiveIntegerField(null=True, verbose_name='Bitrate', blank=True)),
                ('echonest_id', models.CharField(max_length=20, null=True, blank=True)),
                ...
                ('sections', django_extensions.db.fields.json.JSONField(null=True, blank=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('artist', models.ForeignKey(related_name='media_artist', blank=True, to='alibrary.Artist', null=True)),
                ('creator', models.ForeignKey(related_name='media_creator', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('join_phrase', models.CharField(default=None, choices=[(b'&', '&'), (b',', ','), (b'and', 'and'), (b'feat.', 'feat.'), (b'vs.', 'vs.'), (b'-', '-')], max_length=12, blank=True, null=True, verbose_name=b'join phrase')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excerpt', models.TextField(null=True, blank=True)),
                ('in_listing', models.BooleanField(default=True, verbose_name=b'Include in listings')),
            ],
            options={
                'ordering': ('name',),
                'verbose_name': 'Mediaformat',
                'verbose_name_plural': 'Mediaformat',
            },
        ),
        migrations.CreateModel(
            name='NameVariation',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=250, db_index=True)),
                ('artist', models.ForeignKey(related_name='namevariations', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='alibrary.Artist', null=True)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=b'basket', max_length=12, null=True, choices=[(b'basket', 'Private Playlist'), (b'playlist', 'Public Playlist'), (b'broadcast', 'Broadcasts'), (b'other', 'Other')])),
                ('broadcast_status', models.PositiveIntegerField(default=0, choices=[(0, 'Undefined'), (1, 'OK'), (2, 'Warning'), (99, 'Error')])),
                ('broadcast_status_messages', django_extensions.db.fields.json.JSONField(null=True, blank=True)),
                ('edit_mode', models.PositiveIntegerField(default=2, choices=[(0, 'Compact'), (1, 'Medium'), (2, 'Extended')])),
                ('rotation', models.BooleanField(default=True)),
                ('main_image', models.ImageField(upload_to=alibrary.models.playlistmodels.filename_by_uuid, null=True, verbose_name='Image', blank=True)),
                ('d_tags', tagging.fields.TagField(max_length=1024, null=True, verbose_name=b'Tags', blank=True)),
                ('enable_comments', models.BooleanField(default=True, verbose_name='Enable Comments')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(to='alibrary.PlaylistItem')),
                ('playlist', models.ForeignKey(to='alibrary.Playlist')),
            ],
            options={
                'ordering': ('position',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(default=b'generic', max_length=50, null=True, blank=True, choices=[(b'', 'Not specified'), (b'generic', 'Generic'), (b'facebook', 'Facebook'), (b'youtube', 'YouTube'), (b'discogs', 'Discogs'), (b'lastfm', 'Last.fm'), (b'linkedin', 'Linked In'), (b'soundcloud', 'Soundcloud'), (b'twitter', 'Twitter'), (b'discogs_master', 'Discogs | master-release'), (b'wikipedia', 'Wikipedia'), (b'musicbrainz', 'Musicbrainz'), (b'bandcamp', 'Bandcamp'), (b'itunes', 'iTunes'), (b'official', 'Official website')])),
                ('action', models.CharField(default=b'information', max_length=50, choices=[(b'information', 'Information'), (b'buy', 'Buy')])),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('content_type', models.ForeignKey(to='contenttypes.ContentType')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('releasedate_approx', django_date_extensions.fields.ApproximateDateField(max_length=10, null=True, verbose_name=b'Releasedate', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('join_phrase', models.CharField(default=None, choices=[(b'&', '&'), (b',', ','), (b'and', 'and'), (b'feat.', 'feat.'), (b'presents.', 'presents'), (b'meets.', 'meets'), (b'with.', 'with'), (b'vs.', 'vs.'), (b'-', '-')], max_length=12, blank=True, null=True, verbose_name=b'join phrase')),
                ('position', models.PositiveIntegerField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.ForeignKey(related_name='release_extraartist_profession', verbose_name=b'Role/Profession', blank=True, to='alibrary.Profession', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pattern', models.CharField(help_text=b'Regex to match url against. eg ""', max_length=256, null=True, blank=True)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.AddField(
            model_name='release',
            name='cover_image',
            field=filer.fields.image.FilerImageField(related_name='release_cover_image', blank=True, to='filer.Image', help_text='Cover close-up. Used e.g. for embedding in digital files.', null=True),
        ),
        migrations.AddField(
            model_name='release',
            name='creator',
        ...
        migrations.AddField(
            model_name='release',
            name='folder',
            field=models.ForeignKey(related_name='release_folder', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='filer.Folder', null=True),
        ),
        migrations.AddField(
            model_name='release',
            name='label',
        ...
        migrations.AddField(
            model_name='release',
            name='main_format',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='alibrary.Mediaformat', null=True),
        ),
        migrations.AddField(
            model_name='release',
            name='media',
        ...
        migrations.AddField(
            ...
            name='profession',
            field=models.ForeignKey(related_name='media_extraartist_profession', verbose_name=b'Role/Profession', blank=True, to='alibrary.Profession', null=True),
        ),
        migrations.AddField(
            model_name='media',
            name='extra_artists',
        ...
        migrations.AddField(
            model_name='distributor',
            name='owner',
            field=models.ForeignKey(related_name='distributors_owner', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='distributor',
            name='parent',
            field=mptt.fields.TreeForeignKey(related_name='label_children', blank=True, to='alibrary.Distributor', null=True),
        ),
        migrations.AddField(
            model_name='distributor',
            name='publisher',
            field=models.ForeignKey(related_name='distributors_publisher', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='artist',
            name='folder',
            field=models.ForeignKey(related_name='artist_folder', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='filer.Folder', null=True),
        ),
        migrations.AddField(
            model_name='artist',
            name='members',
        ...
        migrations.AddField(
            ...
            name='artist',
            field=models.ForeignKey(to='alibrary.Artist'),
        ),
        migrations.AddField(
            model_name='agencyartist',
            name='countries',
            field=models.ManyToManyField(related_name='agency_countries', to='l10n.Country'),
        ),
        migrations.AddField(
            model_name='agencyartist',
            name='scopes',
            field=models.ManyToManyField(related_name='agency_scopes', to='alibrary.AgencyScope'),
        ),
        migrations.AddField(
            model_name='agency',
            name='artists',
            field=models.ManyToManyField(related_name='agencies', through='alibrary.AgencyArtist', to='alibrary.Artist', blank=True),
        ),
        migrations.AddField(
            model_name='agency',
            name='country',
        ...
        migrations.AddField(
            model_name='agency',
            name='creator',
            field=models.ForeignKey(related_name='agencies_creator', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='agency',
            name='owner',
            field=models.ForeignKey(related_name='agencies_owner', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='agency',
            name='parent',
            field=mptt.fields.TreeForeignKey(related_name='agency_children', blank=True, to='alibrary.Agency', null=True),
        ),
        migrations.AddField(
            model_name='agency',
            name='publisher',
            field=models.ForeignKey(related_name='agencies_publisher', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
