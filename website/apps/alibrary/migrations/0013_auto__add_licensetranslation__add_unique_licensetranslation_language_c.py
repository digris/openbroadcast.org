...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LicenseTranslation'
        db.create_table('alibrary_license_translation', (
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['alibrary.License'])),
        ))
        db.send_create_signal('alibrary', ['LicenseTranslation'])

        # Adding unique constraint on 'LicenseTranslation', fields ['language_code', 'master']
        db.create_unique('alibrary_license_translation', ['language_code', 'master_id'])

        # Deleting field 'License.excerpt'
        db.delete_column('alibrary_license', 'excerpt')

        # Deleting field 'License.license_text'
        db.delete_column('alibrary_license', 'license_text')


    def backwards(self, orm):
        # Removing unique constraint on 'LicenseTranslation', fields ['language_code', 'master']
        db.delete_unique('alibrary_license_translation', ['language_code', 'master_id'])

        # Deleting model 'LicenseTranslation'
        db.delete_table('alibrary_license_translation')

        # Adding field 'License.excerpt'
        db.add_column('alibrary_license', 'excerpt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'License.license_text'
        db.add_column('alibrary_license', 'license_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'91cb259f-3494-4a5b-970f-1dc745e4f611'", 'max_length': '36'})
        },
