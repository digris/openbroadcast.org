...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APILookup'
        db.create_table('alibrary_apilookup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider', self.gf('django.db.models.fields.CharField')(default=None, max_length=50)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['APILookup'])


    def backwards(self, orm):
        # Deleting model 'APILookup'
        db.delete_table('alibrary_apilookup')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'acb7001e-1ef1-4f00-96b3-5a61dc2bf882'", 'max_length': '36'})
        },
