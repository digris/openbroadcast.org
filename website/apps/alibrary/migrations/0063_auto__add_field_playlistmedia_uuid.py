...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaylistMedia.uuid'
        db.add_column('alibrary_playlistmedia', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaylistMedia.uuid'
        db.delete_column('alibrary_playlistmedia', 'uuid')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'515c4c18-02fb-4eb0-aef6-19fb748012b5'", 'max_length': '36'})
        },
