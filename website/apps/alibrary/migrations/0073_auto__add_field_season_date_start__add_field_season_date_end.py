...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.date_start'
        db.add_column('alibrary_season', 'date_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Season.date_end'
        db.add_column('alibrary_season', 'date_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Season.date_start'
        db.delete_column('alibrary_season', 'date_start')

        # Deleting field 'Season.date_end'
        db.delete_column('alibrary_season', 'date_end')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e2dc90dc-f8bf-4490-a2c9-0b8b494d32fd'", 'max_length': '36'})
        },
