...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APILookup.updated'
        db.alter_column('alibrary_apilookup', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'APILookup.created'
        db.alter_column('alibrary_apilookup', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'APILookup.updated'
        db.alter_column('alibrary_apilookup', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'APILookup.created'
        db.alter_column('alibrary_apilookup', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'15bc6daf-67c5-4fde-8153-7c116997c8ee'", 'max_length': '36'})
        },
