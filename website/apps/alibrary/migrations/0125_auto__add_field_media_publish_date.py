...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.publish_date'
        db.add_column('alibrary_media', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.publish_date'
        db.delete_column('alibrary_media', 'publish_date')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6d373814-5a90-4e04-9f6a-bfd784c6850b'", 'max_length': '36'})
        },
