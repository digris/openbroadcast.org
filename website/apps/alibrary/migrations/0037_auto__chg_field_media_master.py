...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Media.master'
        db.alter_column('alibrary_media', 'master', self.gf('private_files.models.fields.PrivateFileField')(max_length=100, null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d6d087e5-2295-48cb-b6af-9d2da6aa0be2'", 'max_length': '36'})
        },
        ...
        'alibrary.media': {
            ...
            'master': ('private_files.models.fields.PrivateFileField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
