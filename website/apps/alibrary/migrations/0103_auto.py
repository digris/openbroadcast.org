...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field countries on 'DistributorLabel'
        db.create_table('alibrary_distributorlabel_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('distributorlabel', models.ForeignKey(orm['alibrary.distributorlabel'], null=False)),
            ('country', models.ForeignKey(orm['l10n.country'], null=False))
        ))
        db.create_unique('alibrary_distributorlabel_countries', ['distributorlabel_id', 'country_id'])


    def backwards(self, orm):
        # Removing M2M table for field countries on 'DistributorLabel'
        db.delete_table('alibrary_distributorlabel_countries')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ad5d8d08-3c5a-4f7d-a487-ac3d9d88b5f2'", 'max_length': '36'})
        },
