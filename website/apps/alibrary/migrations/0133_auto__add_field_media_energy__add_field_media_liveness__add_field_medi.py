...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.energy'
        db.add_column('alibrary_media', 'energy',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.liveness'
        db.add_column('alibrary_media', 'liveness',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.loudness'
        db.add_column('alibrary_media', 'loudness',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.speechiness'
        db.add_column('alibrary_media', 'speechiness',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.start_of_fade_out'
        db.add_column('alibrary_media', 'start_of_fade_out',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.echonest_duration'
        db.add_column('alibrary_media', 'echonest_duration',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.tempo'
        db.add_column('alibrary_media', 'tempo',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.key'
        db.add_column('alibrary_media', 'key',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.energy'
        db.delete_column('alibrary_media', 'energy')

        # Deleting field 'Media.liveness'
        db.delete_column('alibrary_media', 'liveness')

        # Deleting field 'Media.loudness'
        db.delete_column('alibrary_media', 'loudness')

        # Deleting field 'Media.speechiness'
        db.delete_column('alibrary_media', 'speechiness')

        # Deleting field 'Media.start_of_fade_out'
        db.delete_column('alibrary_media', 'start_of_fade_out')

        # Deleting field 'Media.echonest_duration'
        db.delete_column('alibrary_media', 'echonest_duration')

        # Deleting field 'Media.tempo'
        db.delete_column('alibrary_media', 'tempo')

        # Deleting field 'Media.key'
        db.delete_column('alibrary_media', 'key')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9105bbc3-fd96-460c-a5c9-ef134904605d'", 'max_length': '36'})
        },
