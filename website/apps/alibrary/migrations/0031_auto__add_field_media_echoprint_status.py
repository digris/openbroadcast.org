...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.echoprint_status'
        db.add_column('alibrary_media', 'echoprint_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.echoprint_status'
        db.delete_column('alibrary_media', 'echoprint_status')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'607483e5-7dc1-4c02-b9d5-b279d0c1e7e3'", 'max_length': '36'})
        },
