...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Release.release_country' to match new field type.
        db.rename_column('alibrary_release', 'release_country', 'release_country_id')
        # Changing field 'Release.release_country'
        db.alter_column('alibrary_release', 'release_country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['l10n.Country'], null=True))
        # Adding index on 'Release', fields ['release_country']
        db.create_index('alibrary_release', ['release_country_id'])


        # Changing field 'Release.releasetype'
        db.alter_column('alibrary_release', 'releasetype', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))

    def backwards(self, orm):
        # Removing index on 'Release', fields ['release_country']
        db.delete_index('alibrary_release', ['release_country_id'])


        # Renaming column for 'Release.release_country' to match new field type.
        db.rename_column('alibrary_release', 'release_country_id', 'release_country')
        # Changing field 'Release.release_country'
        db.alter_column('alibrary_release', 'release_country', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))

        # Changing field 'Release.releasetype'
        db.alter_column('alibrary_release', 'releasetype', self.gf('django.db.models.fields.CharField')(max_length=24))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4b3b5849-cf2f-4db3-8c84-7b6999d88e24'", 'max_length': '36'})
        },
