...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NameVariation.artist'
        db.alter_column('alibrary_namevariation', 'artist_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['alibrary.Artist']))

    def backwards(self, orm):

        # Changing field 'NameVariation.artist'
        db.alter_column('alibrary_namevariation', 'artist_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['alibrary.Artist']))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'439a7fd9-753b-4cdd-a13b-645063b7dcc2'", 'max_length': '36'})
        },
