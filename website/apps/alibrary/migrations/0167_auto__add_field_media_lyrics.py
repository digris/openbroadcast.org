...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.lyrics'
        db.add_column('alibrary_media', 'lyrics',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.lyrics'
        db.delete_column('alibrary_media', 'lyrics')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'022862e0-e835-4a8f-8f7a-0820faf49847'", 'max_length': '36'})
        },
