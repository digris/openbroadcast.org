...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Label.labelcode'
        db.alter_column('alibrary_label', 'labelcode', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Label.labelcode'
        db.alter_column('alibrary_label', 'labelcode', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d9f3fa3e-b318-4202-8008-19fc159c09f4'", 'max_length': '36'})
        },
