...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.conversion_status'
        db.add_column('alibrary_media', 'conversion_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=2),
                      keep_default=False)


        # Changing field 'Media.master'
        db.alter_column('alibrary_media', 'master', self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True))

    def backwards(self, orm):
        # Deleting field 'Media.conversion_status'
        db.delete_column('alibrary_media', 'conversion_status')


        # Changing field 'Media.master'
        db.alter_column('alibrary_media', 'master', self.gf('private_files.models.fields.PrivateFileField')(max_length=1024, null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'88c5f9b9-1d82-40f1-948d-759ad2a1e233'", 'max_length': '36'})
        },
