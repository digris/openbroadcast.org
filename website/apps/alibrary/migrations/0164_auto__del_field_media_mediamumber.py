...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Media.mediamumber'
        db.delete_column('alibrary_media', 'mediamumber')


    def backwards(self, orm):
        # Adding field 'Media.mediamumber'
        db.add_column('alibrary_media', 'mediamumber',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bd932197-df4b-4f80-8957-bf0350390b9e'", 'max_length': '36'})
        },
