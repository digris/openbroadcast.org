...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.date_start'
        db.add_column('alibrary_label', 'date_start',
                      self.gf('django_date_extensions.fields.ApproximateDateField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.date_end'
        db.add_column('alibrary_label', 'date_end',
                      self.gf('django_date_extensions.fields.ApproximateDateField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.date_start'
        db.delete_column('alibrary_label', 'date_start')

        # Deleting field 'Label.date_end'
        db.delete_column('alibrary_label', 'date_end')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'23ce1630-778d-42a5-a95b-7e3ddb141a15'", 'max_length': '36'})
        },
