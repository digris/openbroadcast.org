...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.force_migration'
        db.add_column('alibrary_media', 'force_migration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.force_migration'
        db.delete_column('alibrary_media', 'force_migration')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'da0401a9-a73d-4057-8f53-70e362910a10'", 'max_length': '36'}),
        ...
        'alibrary.media': {
            ...
            'force_migration': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
