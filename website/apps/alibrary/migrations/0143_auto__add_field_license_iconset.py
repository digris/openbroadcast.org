...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.iconset'
        db.add_column('alibrary_license', 'iconset',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'License.iconset'
        db.delete_column('alibrary_license', 'iconset')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'44f9a4a9-f3f6-4dda-84e0-79d26e908613'", 'max_length': '36'})
        },
