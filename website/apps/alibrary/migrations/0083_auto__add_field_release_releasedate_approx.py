...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.releasedate_approx'
        db.add_column('alibrary_release', 'releasedate_approx',
                      self.gf('django_date_extensions.fields.ApproximateDateField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.releasedate_approx'
        db.delete_column('alibrary_release', 'releasedate_approx')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'159a64cd-4f36-492f-b363-e721613b4c6d'", 'max_length': '36'})
        },
