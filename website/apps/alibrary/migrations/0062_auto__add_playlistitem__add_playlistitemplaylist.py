...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alibrary_playlistitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('alibrary', ['PlaylistItem'])

        # Adding model 'PlaylistItemPlaylist'
        db.create_table('alibrary_playlistitemplaylist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('playlist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Playlist'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.PlaylistItem'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
            ('cue_in', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
            ('cue_out', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
            ('fade_in', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
            ('fade_out', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
        ))
        db.send_create_signal('alibrary', ['PlaylistItemPlaylist'])


    def backwards(self, orm):
        # Deleting model 'PlaylistItem'
        db.delete_table('alibrary_playlistitem')

        # Deleting model 'PlaylistItemPlaylist'
        db.delete_table('alibrary_playlistitemplaylist')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'73dac9aa-9d2d-48f2-9f78-9f1f100ac6fa'", 'max_length': '36'})
        },
