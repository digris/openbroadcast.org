...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.legacy_id'
        db.add_column('alibrary_license', 'legacy_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'License.migrated'
        db.add_column('alibrary_license', 'migrated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'License.legacy_id'
        db.delete_column('alibrary_license', 'legacy_id')

        # Deleting field 'License.migrated'
        db.delete_column('alibrary_license', 'migrated')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'99d54764-2ea9-4f22-89bc-432ad21cd72f'", 'max_length': '36'})
        },
        'alibrary.media': {
