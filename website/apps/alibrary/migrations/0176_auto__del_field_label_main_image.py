...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Label.main_image'
        db.delete_column('alibrary_label', 'main_image_id')


    def backwards(self, orm):
        # Adding field 'Label.main_image'
        db.add_column('alibrary_label', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='label_main_image', null=True, to=orm['filer.Image'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'77defae7-6113-45c1-bef6-a39276247a5c'", 'max_length': '36'})
        },
