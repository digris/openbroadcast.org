...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Agency'
        db.create_table('alibrary_agency', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='agency_children', null=True, to=orm['alibrary.Agency'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agencies_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agencies_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agencies_publisher', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('type', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=12)),
            ('d_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True)),
        ...
        db.send_create_signal('alibrary', ['Agency'])

        # Adding model 'AgencyArtist'
        db.create_table('alibrary_agencyartist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alibrary.Agency'])),
        ...
        db.send_create_signal('alibrary', ['AgencyArtist'])

        # Adding M2M table for field countries on 'AgencyArtist'
        db.create_table('alibrary_agencyartist_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('agencyartist', models.ForeignKey(orm['alibrary.agencyartist'], null=False)),
            ('country', models.ForeignKey(orm['l10n.country'], null=False))
        ))
        db.create_unique('alibrary_agencyartist_countries', ['agencyartist_id', 'country_id'])


    def backwards(self, orm):
        # Deleting model 'Agency'
        db.delete_table('alibrary_agency')

        # Deleting model 'AgencyArtist'
        db.delete_table('alibrary_agencyartist')

        # Removing M2M table for field countries on 'AgencyArtist'
        db.delete_table('alibrary_agencyartist_countries')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8781765b-a1df-4ea2-895a-12d037762247'", 'max_length': '36'})
        },
