...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Artist.main_image'
        db.delete_column('alibrary_artist', 'main_image_id')


    def backwards(self, orm):
        # Adding field 'Artist.main_image'
        db.add_column('alibrary_artist', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='artist_main_image', null=True, to=orm['filer.Image'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8f846cac-5aa8-4838-9eba-2760e5eac67d'", 'max_length': '36'})
        },
