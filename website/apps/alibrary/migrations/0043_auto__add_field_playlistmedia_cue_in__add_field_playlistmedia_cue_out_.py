...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaylistMedia.cue_in'
        db.add_column('alibrary_playlistmedia', 'cue_in',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12),
                      keep_default=False)

        # Adding field 'PlaylistMedia.cue_out'
        db.add_column('alibrary_playlistmedia', 'cue_out',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12),
                      keep_default=False)

        # Adding field 'PlaylistMedia.fade_in'
        db.add_column('alibrary_playlistmedia', 'fade_in',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12),
                      keep_default=False)

        # Adding field 'PlaylistMedia.fade_out'
        db.add_column('alibrary_playlistmedia', 'fade_out',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaylistMedia.cue_in'
        db.delete_column('alibrary_playlistmedia', 'cue_in')

        # Deleting field 'PlaylistMedia.cue_out'
        db.delete_column('alibrary_playlistmedia', 'cue_out')

        # Deleting field 'PlaylistMedia.fade_in'
        db.delete_column('alibrary_playlistmedia', 'fade_in')

        # Deleting field 'PlaylistMedia.fade_out'
        db.delete_column('alibrary_playlistmedia', 'fade_out')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'12847adf-748a-4a99-9d7f-859659539096'", 'max_length': '36'})
        },
