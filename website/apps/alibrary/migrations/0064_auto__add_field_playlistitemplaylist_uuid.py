...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaylistItemPlaylist.uuid'
        db.add_column('alibrary_playlistitemplaylist', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaylistItemPlaylist.uuid'
        db.delete_column('alibrary_playlistitemplaylist', 'uuid')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f9188066-d148-42f6-884e-6e14a3cc8f96'", 'max_length': '36'})
        },
