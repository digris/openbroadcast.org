...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.legacy_id'
        db.add_column('alibrary_playlist', 'legacy_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Playlist.migrated'
        db.add_column('alibrary_playlist', 'migrated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.legacy_id'
        db.delete_column('alibrary_playlist', 'legacy_id')

        # Deleting field 'Playlist.migrated'
        db.delete_column('alibrary_playlist', 'migrated')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'646b605d-9d1a-4409-b50e-b609f963af6f'", 'max_length': '36'})
        },
