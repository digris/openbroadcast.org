...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Distributor.phone'
        db.add_column('alibrary_distributor', 'phone',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Distributor.fax'
        db.add_column('alibrary_distributor', 'fax',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Distributor.phone'
        db.delete_column('alibrary_distributor', 'phone')

        # Deleting field 'Distributor.fax'
        db.delete_column('alibrary_distributor', 'fax')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d853de21-025e-401d-a7a4-3a15ff769cb1'", 'max_length': '36'})
        },
