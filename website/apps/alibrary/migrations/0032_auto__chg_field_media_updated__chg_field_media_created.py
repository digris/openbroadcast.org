...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.updated'
        db.alter_column('alibrary_media', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Media.created'
        db.alter_column('alibrary_media', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Media.updated'
        db.alter_column('alibrary_media', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Media.created'
        db.alter_column('alibrary_media', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5f430340-585f-4a24-817a-75c98b0f5b41'", 'max_length': '36'})
        },
