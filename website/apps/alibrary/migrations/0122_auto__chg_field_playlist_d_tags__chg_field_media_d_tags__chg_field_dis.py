...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Playlist.d_tags'
        db.alter_column('alibrary_playlist', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

        # Changing field 'Media.d_tags'
        db.alter_column('alibrary_media', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

        # Changing field 'Distributor.d_tags'
        db.alter_column('alibrary_distributor', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

        # Changing field 'Artist.d_tags'
        db.alter_column('alibrary_artist', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

        # Changing field 'Release.d_tags'
        db.alter_column('alibrary_release', 'd_tags', self.gf('tagging.fields.TagField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Playlist.d_tags'
        db.alter_column('alibrary_playlist', 'd_tags', self.gf('tagging.fields.TagField')(null=True))

        # Changing field 'Media.d_tags'
        db.alter_column('alibrary_media', 'd_tags', self.gf('tagging.fields.TagField')(null=True))

        # Changing field 'Distributor.d_tags'
        db.alter_column('alibrary_distributor', 'd_tags', self.gf('tagging.fields.TagField')(null=True))

        # Changing field 'Artist.d_tags'
        db.alter_column('alibrary_artist', 'd_tags', self.gf('tagging.fields.TagField')(null=True))

        # Changing field 'Release.d_tags'
        db.alter_column('alibrary_release', 'd_tags', self.gf('tagging.fields.TagField')(null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5b7f4db4-0bca-4708-afeb-888459688c80'", 'max_length': '36'})
        },
