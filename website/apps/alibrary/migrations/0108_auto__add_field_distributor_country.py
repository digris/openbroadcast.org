...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Distributor.country'
        db.add_column('alibrary_distributor', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['l10n.Country'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Distributor.country'
        db.delete_column('alibrary_distributor', 'country_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'665fab1a-6d3d-4acc-8880-262774ed0b5e'", 'max_length': '36'})
        },
