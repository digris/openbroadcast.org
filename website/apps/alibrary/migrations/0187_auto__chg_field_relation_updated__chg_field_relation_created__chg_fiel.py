...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relation.updated'
        db.alter_column('alibrary_relation', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Relation.created'
        db.alter_column('alibrary_relation', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'License.updated'
        db.alter_column('alibrary_license', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'License.created'
        db.alter_column('alibrary_license', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Agency.updated'
        db.alter_column('alibrary_agency', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Agency.created'
        db.alter_column('alibrary_agency', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Profession.updated'
        db.alter_column('alibrary_profession', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Profession.created'
        db.alter_column('alibrary_profession', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Label.updated'
        db.alter_column('alibrary_label', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Label.created'
        db.alter_column('alibrary_label', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Format.updated'
        db.alter_column('alibrary_format', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Format.created'
        db.alter_column('alibrary_format', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Distributor.updated'
        db.alter_column('alibrary_distributor', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Distributor.created'
        db.alter_column('alibrary_distributor', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Artist.updated'
        db.alter_column('alibrary_artist', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Artist.created'
        db.alter_column('alibrary_artist', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Release.updated'
        db.alter_column('alibrary_release', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Release.created'
        db.alter_column('alibrary_release', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Relation.updated'
        db.alter_column('alibrary_relation', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Relation.created'
        db.alter_column('alibrary_relation', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'License.updated'
        db.alter_column('alibrary_license', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'License.created'
        db.alter_column('alibrary_license', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Agency.updated'
        db.alter_column('alibrary_agency', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Agency.created'
        db.alter_column('alibrary_agency', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Profession.updated'
        db.alter_column('alibrary_profession', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Profession.created'
        db.alter_column('alibrary_profession', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Label.updated'
        db.alter_column('alibrary_label', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Label.created'
        db.alter_column('alibrary_label', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Format.updated'
        db.alter_column('alibrary_format', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Format.created'
        db.alter_column('alibrary_format', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Distributor.updated'
        db.alter_column('alibrary_distributor', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Distributor.created'
        db.alter_column('alibrary_distributor', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Artist.updated'
        db.alter_column('alibrary_artist', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Artist.created'
        db.alter_column('alibrary_artist', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Release.updated'
        db.alter_column('alibrary_release', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Release.created'
        db.alter_column('alibrary_release', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'alibrary.artist': {
            ...
            'real_name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'name'", 'overwrite': 'True'}),
        ...
        'alibrary.artistmembership': {
            ...
            'child': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'artist_child'", 'null': 'True', 'to': "orm['alibrary.Artist']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'artist_parent'", 'null': 'True', 'to': "orm['alibrary.Artist']"}),
        ...
        'alibrary.license': {
            'Meta': {'ordering': "('parent__name', 'name')", 'object_name': 'License'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'iconset': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_default': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'is_promotional': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            ...
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'selectable': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7dc1aad8-98e2-4a4f-8314-e84a09ae9be7'", 'max_length': '36'}),
            'version': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'blank': 'True'})
        },
        ...
        'alibrary.media': {
            ...
            'legacy_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'license': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'media_license'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['alibrary.License']"}),
            ...
            'lyrics_language': ('lib.fields.languages.LanguageField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            ...
            'medianumber': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            ...
            'tracknumber': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
        ...
        'alibrary.mediaextraartists': {
            ...
            'artist': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'extraartist_artist'", 'null': 'True', 'to': "orm['alibrary.Artist']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'extraartist_media'", 'null': 'True', 'to': "orm['alibrary.Media']"}),
        ...
        'alibrary.playlist': {
            ...
            'broadcast_status_messages': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'd_tags': ('tagging.fields.TagField', [], {'max_length': '1024', 'null': 'True'}),
        ...
        'alibrary.playlistitemplaylist': {
            'Meta': {'ordering': "('position',)", 'object_name': 'PlaylistItemPlaylist'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'alibrary.release': {
            ...
            'release_country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['l10n.Country']", 'null': 'True', 'blank': 'True'}),
            ...
            'releasetype': ('django.db.models.fields.CharField', [], {'max_length': '24', 'null': 'True', 'blank': 'True'}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'name'", 'overwrite': 'True'}),
