...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaylistMedia.fade_cross'
        db.add_column('alibrary_playlistmedia', 'fade_cross',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaylistMedia.fade_cross'
        db.delete_column('alibrary_playlistmedia', 'fade_cross')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f4f83772-79e7-4704-89b6-af59b5061bf9'", 'max_length': '36'})
        },
