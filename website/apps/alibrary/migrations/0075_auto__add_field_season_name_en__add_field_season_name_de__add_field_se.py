...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.name_en'
        db.add_column('alibrary_season', 'name_en',
    ...
    def backwards(self, orm):
        # Deleting field 'Season.name_en'
        db.delete_column('alibrary_season', 'name_en')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3e8a3d9e-b48d-479e-9b2f-6cc45ad7b65c'", 'max_length': '36'})
        },
