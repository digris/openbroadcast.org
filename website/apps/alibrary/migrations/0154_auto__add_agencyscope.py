...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgencyScope'
        db.create_table('alibrary_agencyscope', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('alibrary', ['AgencyScope'])

        # Adding M2M table for field scopes on 'AgencyArtist'
        db.create_table('alibrary_agencyartist_scopes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('agencyartist', models.ForeignKey(orm['alibrary.agencyartist'], null=False)),
            ('agencyscope', models.ForeignKey(orm['alibrary.agencyscope'], null=False))
        ))
        db.create_unique('alibrary_agencyartist_scopes', ['agencyartist_id', 'agencyscope_id'])


    def backwards(self, orm):
        # Deleting model 'AgencyScope'
        db.delete_table('alibrary_agencyscope')

        # Removing M2M table for field scopes on 'AgencyArtist'
        db.delete_table('alibrary_agencyartist_scopes')
    ...
    models = {
        ...
        'alibrary.agencyartist': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'scopes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['alibrary.AgencyScope']", 'symmetrical': 'False'})
        },
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f6e4efaa-4871-497b-b119-fbc6d8c1daf9'", 'max_length': '36'})
        },
