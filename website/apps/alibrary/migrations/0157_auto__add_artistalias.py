...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alibrary_artistalias', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alias_parent', to=orm['alibrary.Artist'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alias_child', to=orm['alibrary.Artist'])),
        ))
        db.send_create_signal('alibrary', ['ArtistAlias'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('alibrary_artistalias')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ff7433ac-ba16-4b72-877f-8824866cedcc'", 'max_length': '36'})
        },
