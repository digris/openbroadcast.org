...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alibrary_artist', 'tree_id')

        # Deleting field 'Artist.lft'
        db.delete_column('alibrary_artist', 'lft')

        # Deleting field 'Artist.level'
        db.delete_column('alibrary_artist', 'level')

        # Deleting field 'Artist.rght'
        db.delete_column('alibrary_artist', 'rght')

        # Deleting field 'Artist.alias'
        db.delete_column('alibrary_artist', 'alias_id')


    def backwards(self, orm):
        # Adding field 'Artist.tree_id'
        db.add_column('alibrary_artist', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Artist.lft'
        db.add_column('alibrary_artist', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Artist.level'
        db.add_column('alibrary_artist', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Artist.rght'
        db.add_column('alibrary_artist', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Artist.alias'
        db.add_column('alibrary_artist', 'alias',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='aliases', null=True, to=orm['alibrary.Artist'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7bf9974f-764a-4419-9b5f-8737e6f1923f'", 'max_length': '36'})
        },
