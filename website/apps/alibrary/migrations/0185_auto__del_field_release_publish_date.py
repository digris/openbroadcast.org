...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Release.publish_date'
        db.delete_column('alibrary_release', 'publish_date')


    def backwards(self, orm):
        # Adding field 'Release.publish_date'
        db.add_column('alibrary_release', 'publish_date',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'917df6e6-4018-498d-b782-885bc0a6c9a1'", 'max_length': '36'}),
