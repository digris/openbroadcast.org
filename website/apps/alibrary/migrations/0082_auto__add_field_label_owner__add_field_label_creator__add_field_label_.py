...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.owner'
        db.add_column('alibrary_label', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='labels_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Label.creator'
        db.add_column('alibrary_label', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='labels_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Label.publisher'
        db.add_column('alibrary_label', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='labels_publisher', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Media.owner'
        db.add_column('alibrary_media', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Media.creator'
        db.add_column('alibrary_media', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Media.publisher'
        db.add_column('alibrary_media', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_publisher', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Artist.owner'
        db.add_column('alibrary_artist', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artists_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Artist.creator'
        db.add_column('alibrary_artist', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artists_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Artist.publisher'
        db.add_column('alibrary_artist', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artists_publisher', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.owner'
        db.delete_column('alibrary_label', 'owner_id')

        # Deleting field 'Label.creator'
        db.delete_column('alibrary_label', 'creator_id')

        # Deleting field 'Label.publisher'
        db.delete_column('alibrary_label', 'publisher_id')

        # Deleting field 'Media.owner'
        db.delete_column('alibrary_media', 'owner_id')

        # Deleting field 'Media.creator'
        db.delete_column('alibrary_media', 'creator_id')

        # Deleting field 'Media.publisher'
        db.delete_column('alibrary_media', 'publisher_id')

        # Deleting field 'Artist.owner'
        db.delete_column('alibrary_artist', 'owner_id')

        # Deleting field 'Artist.creator'
        db.delete_column('alibrary_artist', 'creator_id')

        # Deleting field 'Artist.publisher'
        db.delete_column('alibrary_artist', 'publisher_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b66c8333-b92e-4052-8153-30be8e8c6c77'", 'max_length': '36'})
        },
