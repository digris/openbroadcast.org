...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Weather.name_en'
        db.add_column('alibrary_weather', 'name_en',
    ...
    def backwards(self, orm):
        # Deleting field 'Weather.name_en'
        db.delete_column('alibrary_weather', 'name_en')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b1043778-8b9a-49b9-8c86-1eac67664978'", 'max_length': '36'})
        },
        ...
        'alibrary.playlist': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'season': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True'}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'name'", 'overwrite': 'True'}),
