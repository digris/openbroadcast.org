...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LicenseTranslation.name'
        db.delete_column('alibrary_license_translation', 'name')

        # Adding field 'LicenseTranslation.name_translated'
        db.add_column('alibrary_license_translation', 'name_translated',
                      self.gf('django.db.models.fields.CharField')(default='whatever', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LicenseTranslation.name'
        db.add_column('alibrary_license_translation', 'name',
                      self.gf('django.db.models.fields.CharField')(default='whatever', max_length=200),
                      keep_default=False)

        # Deleting field 'LicenseTranslation.name_translated'
        db.delete_column('alibrary_license_translation', 'name_translated')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b179ec7d-77bc-42bb-8762-7ecfeee56239'", 'max_length': '36'})
        },
