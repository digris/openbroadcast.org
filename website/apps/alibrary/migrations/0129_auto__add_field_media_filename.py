...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.filename'
        db.add_column('alibrary_media', 'filename',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.filename'
        db.delete_column('alibrary_media', 'filename')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5d9d5e0d-23da-4c13-a49a-9716e39d4504'", 'max_length': '36'})
        },
