...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Label.first_placeholder'
        db.delete_column('alibrary_label', 'first_placeholder_id')


    def backwards(self, orm):
        # Adding field 'Label.first_placeholder'
        db.add_column('alibrary_label', 'first_placeholder',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c966a86e-7f94-4858-a20a-fe50307e8711'", 'max_length': '36'})
        },
