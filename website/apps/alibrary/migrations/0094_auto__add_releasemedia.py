...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReleaseMedia'
        db.create_table('alibrary_releasemedia', (
        ...
        db.send_create_signal('alibrary', ['ReleaseMedia'])

        # Removing M2M table for field media on 'Release'
        db.delete_table('alibrary_release_media')


    def backwards(self, orm):
        # Deleting model 'ReleaseMedia'
        db.delete_table('alibrary_releasemedia')


        # Adding SortedM2M table for field media on 'Release'
        db.create_table('alibrary_release_media', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('release', models.ForeignKey(orm['alibrary.release'], null=False)),
            ('media', models.ForeignKey(orm['alibrary.media'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique('alibrary_release_media', ['release_id', 'media_id'])
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ba4ed1af-20e0-43cb-b3d0-d99da5c0218b'", 'max_length': '36'})
        },
