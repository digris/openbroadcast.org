...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.owner'
        db.add_column('alibrary_release', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Release.publisher'
        db.add_column('alibrary_release', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_publisher', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.owner'
        db.delete_column('alibrary_release', 'owner_id')

        # Deleting field 'Release.publisher'
        db.delete_column('alibrary_release', 'publisher_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ab8dcef9-dc77-48b0-bba5-d84fd547ab62'", 'max_length': '36'})
        },
