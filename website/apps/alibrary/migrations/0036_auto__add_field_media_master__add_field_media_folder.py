...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.master'
        db.add_column('alibrary_media', 'master',
                      self.gf('private_files.models.fields.PrivateFileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.folder'
        db.add_column('alibrary_media', 'folder',
                      self.gf('django.db.models.fields.CharField')(default='/Users/ohrstrom/Documents/Code/openbroadcast.org/website/media/private/', max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.master'
        db.delete_column('alibrary_media', 'master')

        # Deleting field 'Media.folder'
        db.delete_column('alibrary_media', 'folder')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5d36182d-4c28-47bd-9271-30cec50c57da'", 'max_length': '36'})
        },
        ...
        'alibrary.media': {
            ...
            'folder': ('django.db.models.fields.CharField', [], {'default': "'/Users/ohrstrom/Documents/Code/openbroadcast.org/website/media/private/'", 'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'master': ('private_files.models.fields.PrivateFileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
