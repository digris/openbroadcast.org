...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.type'
        db.add_column('alibrary_label', 'type',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.type'
        db.delete_column('alibrary_label', 'type')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a26d985e-ab3a-426b-9539-e2531fa378f6'", 'max_length': '36'})
        },
