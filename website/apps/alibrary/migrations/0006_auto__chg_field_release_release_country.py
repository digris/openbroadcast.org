...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Release.release_country'
        db.alter_column('alibrary_release', 'release_country', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'030a5b74-1144-4fa5-a1da-cfcf0b06042a'", 'max_length': '36'})
        },
        'alibrary.media': {
