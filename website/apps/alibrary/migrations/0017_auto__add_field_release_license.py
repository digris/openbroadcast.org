...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.license'
        db.add_column('alibrary_release', 'license',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_license', null=True, to=orm['alibrary.License']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.license'
        db.delete_column('alibrary_release', 'license_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6a4e355f-ec5e-4658-a0f2-5cb210a824b1'", 'max_length': '36'})
        },
