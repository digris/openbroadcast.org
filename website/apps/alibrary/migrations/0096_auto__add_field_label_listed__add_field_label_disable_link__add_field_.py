...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.listed'
        db.add_column('alibrary_label', 'listed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Label.disable_link'
        db.add_column('alibrary_label', 'disable_link',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Label.disable_editing'
        db.add_column('alibrary_label', 'disable_editing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.listed'
        db.delete_column('alibrary_label', 'listed')

        # Deleting field 'Label.disable_link'
        db.delete_column('alibrary_label', 'disable_link')

        # Deleting field 'Label.disable_editing'
        db.delete_column('alibrary_label', 'disable_editing')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'df133aa9-4daf-49d1-9fca-2a4ff3b72ee1'", 'max_length': '36'})
        },
