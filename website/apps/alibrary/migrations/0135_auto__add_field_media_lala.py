...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.lala'
        db.add_column('alibrary_media', 'lala',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.lala'
        db.delete_column('alibrary_media', 'lala')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b7e4e82c-1177-4f5b-8937-d3840ba577f9'", 'max_length': '36'})
        },
        ...
        'alibrary.media': {
            ...
            'lala': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'legacy_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
