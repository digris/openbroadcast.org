...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Release.tags'
        db.delete_column('alibrary_release', 'tags')

        # Adding field 'Release.d_tags'
        db.add_column('alibrary_release', 'd_tags',
                      self.gf('tagging.fields.TagField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Release.tags'
        db.add_column('alibrary_release', 'tags',
                      self.gf('tagging.fields.TagField')(default=''),
                      keep_default=False)

        # Deleting field 'Release.d_tags'
        db.delete_column('alibrary_release', 'd_tags')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'67193397-9cd4-4e17-852c-63867df6d78f'", 'max_length': '36'})
        },
