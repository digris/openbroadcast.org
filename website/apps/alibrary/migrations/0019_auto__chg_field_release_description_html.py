...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Release.description_html'
        db.alter_column('alibrary_release', 'description_html', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Release.description_html'
        db.alter_column('alibrary_release', 'description_html', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fcb62488-c965-43e7-81a4-1f7e85cc8818'", 'max_length': '36'})
        },
