...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Season.name_de'
        db.delete_column('alibrary_season', 'name_de')

        # Deleting field 'Season.name_fr'
        db.delete_column('alibrary_season', 'name_fr')

        # Deleting field 'Weather.name_fr'
        db.delete_column('alibrary_weather', 'name_fr')

        # Deleting field 'Weather.name_de'
        db.delete_column('alibrary_weather', 'name_de')


        # Changing field 'Media.name'
        db.alter_column('alibrary_media', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'Season.name_de'
        db.add_column('alibrary_season', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Season.name_fr'
        db.add_column('alibrary_season', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Weather.name_fr'
        db.add_column('alibrary_weather', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Weather.name_de'
        db.add_column('alibrary_weather', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'97730be7-4e4f-4d41-ab15-3828343bab21'", 'max_length': '36'})
        },
