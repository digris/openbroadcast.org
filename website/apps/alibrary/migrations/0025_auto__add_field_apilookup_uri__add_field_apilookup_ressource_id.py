...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APILookup.uri'
        db.add_column('alibrary_apilookup', 'uri',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'APILookup.ressource_id'
        db.add_column('alibrary_apilookup', 'ressource_id',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APILookup.uri'
        db.delete_column('alibrary_apilookup', 'uri')

        # Deleting field 'APILookup.ressource_id'
        db.delete_column('alibrary_apilookup', 'ressource_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3b1b85c5-a434-4de7-96db-1d4b9e58d515'", 'max_length': '36'})
        },
