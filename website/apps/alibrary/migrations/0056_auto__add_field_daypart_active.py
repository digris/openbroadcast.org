...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Daypart.active'
        db.add_column('alibrary_daypart', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Daypart.active'
        db.delete_column('alibrary_daypart', 'active')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ca1f958c-fb8d-412e-b5f4-d058503697f0'", 'max_length': '36'})
        },
