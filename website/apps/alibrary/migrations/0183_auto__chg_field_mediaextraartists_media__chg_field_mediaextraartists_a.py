...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaExtraartists.media'
        db.alter_column('alibrary_mediaextraartists', 'media_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alibrary.Media']))

        # Changing field 'MediaExtraartists.artist'
        db.alter_column('alibrary_mediaextraartists', 'artist_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alibrary.Artist']))

    def backwards(self, orm):

        # Changing field 'MediaExtraartists.media'
        db.alter_column('alibrary_mediaextraartists', 'media_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['alibrary.Media']))

        # Changing field 'MediaExtraartists.artist'
        db.alter_column('alibrary_mediaextraartists', 'artist_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['alibrary.Artist']))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'07aae5c5-adbf-4f53-ae00-5f4eca6cc908'", 'max_length': '36'}),
