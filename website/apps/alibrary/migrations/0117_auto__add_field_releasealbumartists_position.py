...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReleaseAlbumartists.position'
        db.add_column('alibrary_releasealbumartists', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReleaseAlbumartists.position'
        db.delete_column('alibrary_releasealbumartists', 'position')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'33da9e3d-067f-4369-9150-d46b9690410f'", 'max_length': '36'})
        },
