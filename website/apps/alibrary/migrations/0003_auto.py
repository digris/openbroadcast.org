...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Release', fields ['name']
        db.create_index('alibrary_release', ['name'])


    def backwards(self, orm):
        # Removing index on 'Release', fields ['name']
        db.delete_index('alibrary_release', ['name'])
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7fb64d50-977a-413e-8f74-65c7654564c3'", 'max_length': '36'})
        },
        'alibrary.media': {
