...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.medianumber'
        db.alter_column('alibrary_media', 'medianumber', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'Media.medianumber'
        db.alter_column('alibrary_media', 'medianumber', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c95287ce-9151-44e7-a390-8c66b2e1fafd'", 'max_length': '36'})
        },
