...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaylistMedia.created'
        db.alter_column('alibrary_playlistmedia', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'PlaylistItemPlaylist.created'
        db.alter_column('alibrary_playlistitemplaylist', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'PlaylistMedia.created'
        db.alter_column('alibrary_playlistmedia', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'PlaylistItemPlaylist.created'
        db.alter_column('alibrary_playlistitemplaylist', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a2e7408c-cd03-4b28-9051-fb99666eae5b'", 'max_length': '36'})
        },
