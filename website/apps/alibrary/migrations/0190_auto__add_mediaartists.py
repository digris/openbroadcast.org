...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MediaArtists'
        db.create_table('alibrary_mediaartists', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='artist_mediaartist', to=orm['alibrary.Artist'])),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_mediaartist', to=orm['alibrary.Media'])),
            ('join_phrase', self.gf('django.db.models.fields.CharField')(default=None, max_length=12, null=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('alibrary', ['MediaArtists'])


    def backwards(self, orm):
        # Deleting model 'MediaArtists'
        db.delete_table('alibrary_mediaartists')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6c7a24c3-c0f7-4eec-9518-d31f34a48658'", 'max_length': '36'}),
