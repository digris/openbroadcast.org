...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.disc_number'
        db.add_column('alibrary_media', 'disc_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.opus_number'
        db.add_column('alibrary_media', 'opus_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.disc_number'
        db.delete_column('alibrary_media', 'disc_number')

        # Deleting field 'Media.opus_number'
        db.delete_column('alibrary_media', 'opus_number')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'40e777d0-7d6f-4017-a2c9-bf900a577fb2'", 'max_length': '36'})
        },
        ...
        'alibrary.media': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'disc_number': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
