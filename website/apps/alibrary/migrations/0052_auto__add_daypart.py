...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alibrary_daypart', (
        ...
        db.send_create_signal('alibrary', ['Daypart'])


    def backwards(self, orm):
        # Deleting model 'Daypart'
        db.delete_table('alibrary_daypart')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bd2a33ed-8987-4690-9abf-21960379600c'", 'max_length': '36'})
        },
