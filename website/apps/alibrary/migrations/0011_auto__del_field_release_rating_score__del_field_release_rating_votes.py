...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Release.rating_score'
        db.delete_column('alibrary_release', 'rating_score')

        # Deleting field 'Release.rating_votes'
        db.delete_column('alibrary_release', 'rating_votes')


    def backwards(self, orm):
        # Adding field 'Release.rating_score'
        db.add_column('alibrary_release', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Release.rating_votes'
        db.add_column('alibrary_release', 'rating_votes',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6317bd67-379d-4663-afe3-d441b4e9f3a1'", 'max_length': '36'})
        },
        'alibrary.media': {
