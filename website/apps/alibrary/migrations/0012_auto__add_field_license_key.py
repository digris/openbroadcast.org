...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.key'
        db.add_column('alibrary_license', 'key',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'License.key'
        db.delete_column('alibrary_license', 'key')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cab3a5c9-25a2-482e-92a7-f66c028d8b31'", 'max_length': '36'})
        },
        'alibrary.media': {
