...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alibrary_media', 'folder_id')


    def backwards(self, orm):
        # Adding field 'Media.folder'
        db.add_column('alibrary_media', 'folder',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_folder', null=True, to=orm['filer.Folder'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'68e7491b-e4cc-469d-98bf-59abda1a18ff'", 'max_length': '36'})
        },
