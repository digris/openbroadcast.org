...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Season'
        db.create_table('alibrary_season', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('alibrary', ['Season'])

        # Adding field 'Playlist.season'
        db.add_column('alibrary_playlist', 'season',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('alibrary_season')

        # Deleting field 'Playlist.season'
        db.delete_column('alibrary_playlist', 'season')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cb0757d4-9c95-4a2b-bc62-170e7a51197e'", 'max_length': '36'})
        },
