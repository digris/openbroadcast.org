...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alibrary_artist', 'alias',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='aliases', null=True, to=orm['alibrary.Artist']),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.artist': {
            ...
            'alias': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'aliases'", 'null': 'True', 'to': "orm['alibrary.Artist']"}),
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'73fbd724-db38-459c-b901-6d909cfa74cf'", 'max_length': '36'})
        },
