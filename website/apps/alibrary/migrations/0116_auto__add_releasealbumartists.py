...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReleaseAlbumartists'
        db.create_table('alibrary_releasealbumartists', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_albumartist_artist', to=orm['alibrary.Artist'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_albumartist_release', to=orm['alibrary.Release'])),
            ('join_phrase', self.gf('django.db.models.fields.CharField')(default='&', max_length=12)),
        ))
        db.send_create_signal('alibrary', ['ReleaseAlbumartists'])


    def backwards(self, orm):
        # Deleting model 'ReleaseAlbumartists'
        db.delete_table('alibrary_releasealbumartists')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2e7e62e8-887d-4fe2-bc3f-4eac796c32e9'", 'max_length': '36'})
        },
