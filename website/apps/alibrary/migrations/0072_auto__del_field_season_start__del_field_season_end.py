...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alibrary_season', 'start')

        # Deleting field 'Season.end'
        db.delete_column('alibrary_season', 'end')


    def backwards(self, orm):
        # Adding field 'Season.start'
        db.add_column('alibrary_season', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Season.end'
        db.add_column('alibrary_season', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cad61b45-776c-4c48-b015-db4117cf20b6'", 'max_length': '36'})
        },
