...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.description'
        db.add_column('alibrary_label', 'description',
                      self.gf('lib.fields.extra.MarkdownTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.description_html'
        db.add_column('alibrary_label', 'description_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.description'
        db.delete_column('alibrary_label', 'description')

        # Deleting field 'Label.description_html'
        db.delete_column('alibrary_label', 'description_html')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4de2089a-1766-4dc8-a246-c96d05915e8e'", 'max_length': '36'})
        },
