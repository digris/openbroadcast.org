...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Media.master_path'
        db.delete_column('alibrary_media', 'master_path')


    def backwards(self, orm):
        # Adding field 'Media.master_path'
        db.add_column('alibrary_media', 'master_path',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'59eb0d7f-6e2f-4976-b447-100567653e1e'", 'max_length': '36'})
        },
