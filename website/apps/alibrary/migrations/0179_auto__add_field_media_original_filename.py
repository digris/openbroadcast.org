...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.original_filename'
        db.add_column('alibrary_media', 'original_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.original_filename'
        db.delete_column('alibrary_media', 'original_filename')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a06f6c66-427c-4e2c-97ae-14509a17018d'", 'max_length': '36'})
        },
