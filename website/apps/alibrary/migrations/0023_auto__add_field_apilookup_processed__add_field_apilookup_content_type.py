...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APILookup.processed'
        db.add_column('alibrary_apilookup', 'processed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'APILookup.content_type'
        db.add_column('alibrary_apilookup', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APILookup.processed'
        db.delete_column('alibrary_apilookup', 'processed')

        # Deleting field 'APILookup.content_type'
        db.delete_column('alibrary_apilookup', 'content_type_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0b95a8e6-09d3-469f-984e-d5cd167889fb'", 'max_length': '36'})
        },
