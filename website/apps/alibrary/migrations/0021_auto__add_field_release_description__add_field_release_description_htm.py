...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alibrary_release', 'description',
                      self.gf('lib.fields.extra.MarkdownTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Release.description_html'
        db.add_column('alibrary_release', 'description_html',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('alibrary_release', 'description')

        # Deleting field 'Release.description_html'
        db.delete_column('alibrary_release', 'description_html')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8e6b886f-b0f9-48fb-996a-35fd573b7690'", 'max_length': '36'})
        },
