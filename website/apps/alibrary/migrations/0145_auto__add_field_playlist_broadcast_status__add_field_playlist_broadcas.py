...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.broadcast_status'
        db.add_column('alibrary_playlist', 'broadcast_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Playlist.broadcast_status_messages'
        db.add_column('alibrary_playlist', 'broadcast_status_messages',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.broadcast_status'
        db.delete_column('alibrary_playlist', 'broadcast_status')

        # Deleting field 'Playlist.broadcast_status_messages'
        db.delete_column('alibrary_playlist', 'broadcast_status_messages')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'22e98693-b245-4c35-9911-2818ca612733'", 'max_length': '36'})
        },
