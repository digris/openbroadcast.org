...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'APILookup.api_data'
        db.add_column('alibrary_apilookup', 'api_data',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'APILookup.api_data'
        db.delete_column('alibrary_apilookup', 'api_data')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d2f90eea-d28d-4f9a-b3af-8c775e83c5b3'", 'max_length': '36'})
        },
