...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.master_sha1'
        db.add_column('alibrary_media', 'master_sha1',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.master_sha1'
        db.delete_column('alibrary_media', 'master_sha1')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ab535db5-e5b8-43e5-b8b9-d442e2864566'", 'max_length': '36'})
        },
