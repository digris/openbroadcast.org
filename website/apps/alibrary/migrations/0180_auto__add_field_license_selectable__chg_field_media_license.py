...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.selectable'
        db.add_column('alibrary_license', 'selectable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Media.license'
        db.alter_column('alibrary_media', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['alibrary.License']))

    def backwards(self, orm):
        # Deleting field 'License.selectable'
        db.delete_column('alibrary_license', 'selectable')


        # Changing field 'Media.license'
        db.alter_column('alibrary_media', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alibrary.License']))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'665eed0c-b41e-4b2e-b73b-4126f1dd4329'", 'max_length': '36'})
        },
