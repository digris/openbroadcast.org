...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.base_format'
        db.add_column('alibrary_media', 'base_format',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.base_filesize'
        db.add_column('alibrary_media', 'base_filesize',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.base_duration'
        db.add_column('alibrary_media', 'base_duration',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.base_samplerate'
        db.add_column('alibrary_media', 'base_samplerate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.base_bitrate'
        db.add_column('alibrary_media', 'base_bitrate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.base_format'
        db.delete_column('alibrary_media', 'base_format')

        # Deleting field 'Media.base_filesize'
        db.delete_column('alibrary_media', 'base_filesize')

        # Deleting field 'Media.base_duration'
        db.delete_column('alibrary_media', 'base_duration')

        # Deleting field 'Media.base_samplerate'
        db.delete_column('alibrary_media', 'base_samplerate')

        # Deleting field 'Media.base_bitrate'
        db.delete_column('alibrary_media', 'base_bitrate')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'76527a73-89df-4a62-9949-3e36711464a3'", 'max_length': '36'})
        },
