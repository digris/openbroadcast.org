...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model '__old_Relation__'
        db.delete_table('alibrary___old_relation__')
    ...
    def backwards(self, orm):
        # Adding model '__old_Relation__'
        db.create_table('alibrary___old_relation__', (
        ...
        db.send_create_signal('alibrary', ['__old_Relation__'])
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f39901d6-6dee-4d15-b0d5-d6239221d7da'", 'max_length': '36'})
        },
