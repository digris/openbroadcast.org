...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APILookup.object_id'
        db.add_column('alibrary_apilookup', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APILookup.object_id'
        db.delete_column('alibrary_apilookup', 'object_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f3ed10fe-03d6-4b2e-a920-3e69573d8bb5'", 'max_length': '36'})
        },
