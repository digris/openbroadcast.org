...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Playlist.playlisttype'
        db.delete_column('alibrary_playlist', 'playlisttype')

        # Adding field 'Playlist.type'
        db.add_column('alibrary_playlist', 'type',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=12, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Playlist.playlisttype'
        db.add_column('alibrary_playlist', 'playlisttype',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=12),
                      keep_default=False)

        # Deleting field 'Playlist.type'
        db.delete_column('alibrary_playlist', 'type')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f5705f90-af30-4d41-abd7-5d509b21d2fd'", 'max_length': '36'})
        },
