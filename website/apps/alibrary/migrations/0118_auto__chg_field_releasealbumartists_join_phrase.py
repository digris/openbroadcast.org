...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReleaseAlbumartists.join_phrase'
        db.alter_column('alibrary_releasealbumartists', 'join_phrase', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'ReleaseAlbumartists.join_phrase'
        db.alter_column('alibrary_releasealbumartists', 'join_phrase', self.gf('django.db.models.fields.CharField')(max_length=12))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d6b4eab8-dde2-4a64-a095-dc78b8ae83ca'", 'max_length': '36'})
        },
