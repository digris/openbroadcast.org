...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alibrary_media', 'master_id')


    def backwards(self, orm):
        # Adding field 'Media.master'
        db.add_column('alibrary_media', 'master',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_master', null=True, to=orm['filer.Audio'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5456865b-7239-447f-ad03-c6da8c8a3a66'", 'max_length': '36'})
        },
