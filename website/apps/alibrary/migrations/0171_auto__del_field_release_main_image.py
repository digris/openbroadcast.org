...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Release.main_image'
        db.delete_column('alibrary_release', 'main_image_id')


    def backwards(self, orm):
        # Adding field 'Release.main_image'
        db.add_column('alibrary_release', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_main_image', null=True, to=orm['filer.Image'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'84469de5-1f55-494f-990a-93e042690342'", 'max_length': '36'})
        },
