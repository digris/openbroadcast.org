...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.main_image'
        db.add_column('alibrary_playlist', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='playlist_main_image', null=True, to=orm['filer.Image']),
                      keep_default=False)

        # Adding field 'Playlist.d_tags'
        db.add_column('alibrary_playlist', 'd_tags',
                      self.gf('tagging.fields.TagField')(null=True),
                      keep_default=False)

        # Adding field 'Playlist.enable_comments'
        db.add_column('alibrary_playlist', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Playlist.slug'
        db.alter_column('alibrary_playlist', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from='name', overwrite=True))

    def backwards(self, orm):
        # Deleting field 'Playlist.main_image'
        db.delete_column('alibrary_playlist', 'main_image_id')

        # Deleting field 'Playlist.d_tags'
        db.delete_column('alibrary_playlist', 'd_tags')

        # Deleting field 'Playlist.enable_comments'
        db.delete_column('alibrary_playlist', 'enable_comments')


        # Changing field 'Playlist.slug'
        db.alter_column('alibrary_playlist', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'861d2b1f-dec7-42fa-a887-140ceb055a45'", 'max_length': '36'})
        },
        ...
        'alibrary.playlist': {
            ...
            'enable_comments': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'playlist_main_image'", 'null': 'True', 'to': "orm['filer.Image']"}),
