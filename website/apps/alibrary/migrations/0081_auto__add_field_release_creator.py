...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.creator'
        db.add_column('alibrary_release', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='releases_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.creator'
        db.delete_column('alibrary_release', 'creator_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cc5784b3-acff-4a67-a0fa-32ee07d70705'", 'max_length': '36'})
        },
