...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Release.releasetype'
        db.alter_column('alibrary_release', 'releasetype', self.gf('django.db.models.fields.CharField')(max_length=12))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bc31b99c-b6e2-4e78-97a0-7d34817fcf06'", 'max_length': '36'})
        },
