...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Label.country'
        db.delete_column('alibrary_label', 'country')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Label.country'
        db.add_column('alibrary_label', 'country',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4c963e40-3f54-458c-9cdc-83720e05b726'", 'max_length': '36'})
        },
