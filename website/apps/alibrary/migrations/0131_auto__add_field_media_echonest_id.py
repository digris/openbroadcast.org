...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.echonest_id'
        db.add_column('alibrary_media', 'echonest_id',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.echonest_id'
        db.delete_column('alibrary_media', 'echonest_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cfa2b63a-8c20-47d0-a1c6-ee8638e9d246'", 'max_length': '36'})
        },
