...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('alibrary_label', 'labelcode', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'336f6f96-fdc5-4499-b3b7-d5722003661e'", 'max_length': '36'})
        },
