...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APILookup.api_data'
        db.alter_column('alibrary_apilookup', 'api_data', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Media.sections'
        db.add_column('alibrary_media', 'sections',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'APILookup.api_data'
        db.alter_column('alibrary_apilookup', 'api_data', self.gf('jsonfield.fields.JSONField')(null=True))
        # Deleting field 'Media.sections'
        db.delete_column('alibrary_media', 'sections')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'281ca266-8d6a-475e-b128-5ffcece68397'", 'max_length': '36'})
        },
