...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NameVariation.name'
        db.alter_column('alibrary_namevariation', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))
        # Adding field 'Media.lyrics_language'
        db.add_column('alibrary_media', 'lyrics_language',
                      self.gf('lib.fields.languages.LanguageField')(max_length=5, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Media.tracknumber'
        db.alter_column('alibrary_media', 'tracknumber', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12, null=True))

        # Changing field 'Artist.name'
        db.alter_column('alibrary_artist', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Artist.real_name'
        db.alter_column('alibrary_artist', 'real_name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'NameVariation.name'
        db.alter_column('alibrary_namevariation', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Deleting field 'Media.lyrics_language'
        db.delete_column('alibrary_media', 'lyrics_language')


        # Changing field 'Media.tracknumber'
        db.alter_column('alibrary_media', 'tracknumber', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12))

        # Changing field 'Artist.name'
        db.alter_column('alibrary_artist', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Artist.real_name'
        db.alter_column('alibrary_artist', 'real_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'33d76d14-22f7-4fe4-b263-77ea264b5047'", 'max_length': '36'})
        },
