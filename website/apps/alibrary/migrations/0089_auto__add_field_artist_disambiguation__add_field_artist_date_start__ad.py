...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.disambiguation'
        db.add_column('alibrary_artist', 'disambiguation',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.date_start'
        db.add_column('alibrary_artist', 'date_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.date_end'
        db.add_column('alibrary_artist', 'date_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.disambiguation'
        db.delete_column('alibrary_artist', 'disambiguation')

        # Deleting field 'Artist.date_start'
        db.delete_column('alibrary_artist', 'date_start')

        # Deleting field 'Artist.date_end'
        db.delete_column('alibrary_artist', 'date_end')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ee7f17f3-6a7d-4426-920d-863dc7c89b55'", 'max_length': '36'})
        },
