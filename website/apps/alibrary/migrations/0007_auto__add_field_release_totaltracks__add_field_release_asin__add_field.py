...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.totaltracks'
        db.add_column('alibrary_release', 'totaltracks',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Release.asin'
        db.add_column('alibrary_release', 'asin',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'Release.releasestatus'
        db.add_column('alibrary_release', 'releasestatus',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.totaltracks'
        db.delete_column('alibrary_release', 'totaltracks')

        # Deleting field 'Release.asin'
        db.delete_column('alibrary_release', 'asin')

        # Deleting field 'Release.releasestatus'
        db.delete_column('alibrary_release', 'releasestatus')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'68c6e95c-d06f-498c-8162-25118f587279'", 'max_length': '36'})
        },
        'alibrary.media': {
