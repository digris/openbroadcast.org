...
from .views import LabelDetailView, LabelListView, LabelEditView, LabelStatisticsDownloadView
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/statistics-download/$', LabelStatisticsDownloadView.as_view(), name='alibrary-label-statistics-download'),
]
