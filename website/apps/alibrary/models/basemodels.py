...
class Distributor(
    ...
    labels = models.ManyToManyField(
        "Label", through="DistributorLabel", blank=True, related_name="distributors"
    )
...
class License(
    ...
    parent = models.ForeignKey(
        "self", null=True, blank=True, related_name="license_children"
    )
...
class Relation(
    ...
    action = models.CharField(
        max_length=50, default="information", choices=ACTION_CHOICES
    )
