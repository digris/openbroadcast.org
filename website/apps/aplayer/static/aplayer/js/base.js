...
aplayer.base.load = function (play) {
    ...
    console.debug('aplayer.base.load - callback from remote window. object to play:', play);
...
aplayer.base.load_playlist = function (uri) {
    ...
    console.debug('aplayer.base.load_playlist', uri);
    ...
    if (uri) {
        ...
        $.ajax({
            ...
            success: function (result, textStatus, jqXHR) {
                ...
                console.debug('loaded playlist:', result);
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                ...
                // console.debug(errorThrown, 'Error');
            }
        });
    }
};
...
aplayer.base.grab_player = function (focus) {
    ...
    if (typeof (local.aplayer) != 'undefined') {
        ...
        if (aplayer.vars.debug) {
            console.debug('found no player. create the popup or try to attach');
        }
...
aplayer.base.controls = function (args) {
    ...
    console.debug('aplayer.base.controls:', args);
    ...
    if (action == 'seek' && position) {
        ...
        if (uuid && uuid == aplayer.states.uuid) {
            ...
            // console.debug('seek with SAME uuid');
            jwp.seek(p);
            ...
            // console.debug('seek with DIFFERENT uuid');
...
aplayer.on_playlist = function (event) {
    ...
    //console.debug(aplayer.vars.states, 'states');
