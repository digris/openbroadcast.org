...
class ChangeTrackerModelRegistry(object):
    ...
    def __init__(self, create=True, update=True, delete=True, custom=None):
        from changetracker.receivers import log_create, log_update, log_delete
...
class AuditLogModelRegistry(ChangeTrackerModelRegistry):
    def __init__(self, *args, **kwargs):
        super(AuditLogModelRegistry, self).__init__(*args, **kwargs)
        raise DeprecationWarning("Use ChangeTrackerModelRegistry instead of AuditLogModelRegistry, AuditLogModelRegistry will be removed in django-changetracker 0.4.0 or later.")


changetracker = ChangeTrackerModelRegistry()