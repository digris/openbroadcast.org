...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.placeholder_1'
        db.add_column('articles_article', 'placeholder_1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.placeholder_1'
        db.delete_column('articles_article', 'placeholder_1_id')
