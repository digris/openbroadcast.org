...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.artist'
        db.add_column('spf_match', 'artist',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Match.artist_credits'
        db.add_column('spf_match', 'artist_credits',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Match.release'
        db.add_column('spf_match', 'release',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.artist'
        db.delete_column('spf_match', 'artist')

        # Deleting field 'Match.artist_credits'
        db.delete_column('spf_match', 'artist_credits')

        # Deleting field 'Match.release'
        db.delete_column('spf_match', 'release')
