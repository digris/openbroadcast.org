    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(unique=True, max_length=40, verbose_name='invitation key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('available', models.IntegerField(default=5, verbose_name='available invitations')),
                ...
                ('user', models.OneToOneField(related_name='invitation_stats', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-user',),
