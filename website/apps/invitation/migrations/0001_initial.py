...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitation_invitation', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitations', to=orm['auth.User'])),
        ...
        # Adding model 'InvitationStats'
        db.create_table('invitation_invitationstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='invitation_stats', unique=True, to=orm['auth.User'])),
            ('available', self.gf('django.db.models.fields.IntegerField')(default=5)),
        ...
        db.send_create_signal('invitation', ['InvitationStats'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'InvitationStats'
        db.delete_table('invitation_invitationstats')
