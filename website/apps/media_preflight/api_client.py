...
API_BASE_URL = getattr(
    settings, "MEDIA_PREFLIGHT_API_BASE_URL", "http://127.0.0.1:7779/api/v1/"
)
...
class MediaPreflightAPIClient(object):
    ...
    def __init__(self, auth_token=AUTH_TOKEN):
        ...
        self.headers = {"user-agent": "openbroadcast.org - preflight client/0.0.1"}
    ...
    def check(self):
        ...
        url = "{api_base_url}status/".format(api_base_url=API_BASE_URL)
