...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hardwarerelease.circulation'
        db.add_column('ashop_hardwarerelease', 'circulation', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hardwarerelease.circulation'
        db.delete_column('ashop_hardwarerelease', 'circulation')
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cc51b00e-892f-403d-9bb8-3d5317c0dca5'", 'max_length': '36'})
        },
        'alibrary.profession': {
