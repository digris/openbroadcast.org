...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Releaseproduct.release'
        db.add_column('ashop_releaseproduct', 'release', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['alibrary.Release']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Releaseproduct.release'
        db.delete_column('ashop_releaseproduct', 'release_id')
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cc3eb5eb-f828-4805-b5a9-a469674b4690'", 'max_length': '36'})
        },
        'alibrary.profession': {
