...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('cmsplugin_singleproduct')
    ...
    def backwards(self, orm):
        ...
        db.create_table('cmsplugin_singleproduct', (
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ashop.Baseproduct'])),
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('style', self.gf('django.db.models.fields.CharField')(default='l', max_length=24)),
        ))
        db.send_create_signal('ashop', ['SingleProduct'])

        # Adding model 'Baseproduct'
        db.create_table('ashop_baseproduct', (
            ('picture', self.gf('django.db.models.fields.related.ForeignKey')(related_name='baseproduct_picture', null=True, to=orm['filer.Image'], blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('subline', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('picture_listing', self.gf('django.db.models.fields.related.ForeignKey')(related_name='baseproduct_picture_listing', null=True, to=orm['filer.Image'], blank=True)),
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b1692159-36ba-48c6-a244-c0c12c931870'", 'max_length': '36'})
        },
        'alibrary.profession': {
