...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SingleProduct.product'
        db.alter_column('cmsplugin_singleproduct', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Baseproduct']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SingleProduct.product'
        db.alter_column('cmsplugin_singleproduct', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ashop.Baseproduct']))
    ...
    models = {
        ...
        'ashop.singleproduct': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Baseproduct']"})
        },
        'auth.group': {
        ...
        'shop.baseproduct': {
            'Meta': {'object_name': 'Baseproduct', '_ormbases': ['shop.Product']},
