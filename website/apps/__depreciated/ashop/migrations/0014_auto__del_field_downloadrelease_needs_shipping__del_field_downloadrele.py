...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Downloadrelease.needs_shipping'
        db.delete_column('ashop_downloadrelease', 'needs_shipping')

        # Deleting field 'Downloadrelease.weight'
        db.delete_column('ashop_downloadrelease', 'weight')

        # Adding field 'Hardwarerelease.description'
        db.add_column('ashop_hardwarerelease', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Downloadrelease.needs_shipping'
        db.add_column('ashop_downloadrelease', 'needs_shipping', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Downloadrelease.weight'
        db.add_column('ashop_downloadrelease', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Hardwarerelease.description'
        db.delete_column('ashop_hardwarerelease', 'description')
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'829427c7-2d7e-496e-b1f6-df5de9dc1f4e'", 'max_length': '36'})
        },
        'alibrary.profession': {
