...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SingleProduct.style'
        db.add_column('cmsplugin_singleproduct', 'style', self.gf('django.db.models.fields.CharField')(default='l', max_length=24), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SingleProduct.style'
        db.delete_column('cmsplugin_singleproduct', 'style')
