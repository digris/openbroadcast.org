...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Downloadrelease'
        db.create_table('ashop_downloadrelease', (
            ...
            ('needs_shipping', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('ashop', ['Downloadrelease'])

        # Adding model 'Hardwarerelease'
        db.create_table('ashop_hardwarerelease', (
            ('product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Product'], unique=True, primary_key=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('needs_shipping', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('ashop', ['Hardwarerelease'])

        # Adding field 'Baseproduct.picture'
        db.add_column('ashop_baseproduct', 'picture', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='baseproduct_picture', null=True, to=orm['filer.Image']), keep_default=False)

        # Adding field 'Baseproduct.picture_listing'
        db.add_column('ashop_baseproduct', 'picture_listing', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='baseproduct_picture_listing', null=True, to=orm['filer.Image']), keep_default=False)

        # Adding field 'Baseproduct.subline'
        db.add_column('ashop_baseproduct', 'subline', self.gf('django.db.models.fields.CharField')(default='subline', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Downloadrelease'
        db.delete_table('ashop_downloadrelease')

        # Deleting model 'Hardwarerelease'
        db.delete_table('ashop_hardwarerelease')
    ...
    models = {
        ...
        'ashop.downloadrelease': {
            'Meta': {'ordering': "['name']", 'object_name': 'Downloadrelease', '_ormbases': ['shop.Product']},
            'needs_shipping': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'product_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Product']", 'unique': 'True', 'primary_key': 'True'}),
            'weight': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'ashop.hardwarerelease': {
            'Meta': {'ordering': "['name']", 'object_name': 'Hardwarerelease', '_ormbases': ['shop.Product']},
            'needs_shipping': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'product_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Product']", 'unique': 'True', 'primary_key': 'True'}),
            'weight': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
