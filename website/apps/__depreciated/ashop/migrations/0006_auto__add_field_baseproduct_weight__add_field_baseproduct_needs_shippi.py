...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Baseproduct.weight'
        db.add_column('ashop_baseproduct', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Baseproduct.needs_shipping'
        db.add_column('ashop_baseproduct', 'needs_shipping', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'Baseproduct.description'
        db.alter_column('ashop_baseproduct', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Baseproduct.weight'
        db.delete_column('ashop_baseproduct', 'weight')

        # Deleting field 'Baseproduct.needs_shipping'
        db.delete_column('ashop_baseproduct', 'needs_shipping')

        # Changing field 'Baseproduct.description'
        db.alter_column('ashop_baseproduct', 'description', self.gf('django.db.models.fields.TextField')(default=''))
