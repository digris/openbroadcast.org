...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('addressmodel_address', 'state')


    def backwards(self, orm):
        
        # Adding field 'Address.state'
        db.add_column('addressmodel_address', 'state', self.gf('django.db.models.fields.CharField')(default='none', max_length=255), keep_default=False)
