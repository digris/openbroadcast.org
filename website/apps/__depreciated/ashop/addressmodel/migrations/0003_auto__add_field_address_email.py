...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('addressmodel_address', 'email', self.gf('django.db.models.fields.EmailField')(default='none@none.no', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.email'
        db.delete_column('addressmodel_address', 'email')
