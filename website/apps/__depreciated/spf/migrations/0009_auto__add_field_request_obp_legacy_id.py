...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.obp_legacy_id'
        db.add_column('spf_request', 'obp_legacy_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.obp_legacy_id'
        db.delete_column('spf_request', 'obp_legacy_id')
