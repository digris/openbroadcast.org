...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request.publication_date'
        db.alter_column('spf_request', 'publication_date', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Request.publication_date'
        db.alter_column('spf_request', 'publication_date', self.gf('django.db.models.fields.DateField')(null=True))
