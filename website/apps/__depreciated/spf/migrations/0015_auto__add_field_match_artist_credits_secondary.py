...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.artist_credits_secondary'
        db.add_column('spf_match', 'artist_credits_secondary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.artist_credits_secondary'
        db.delete_column('spf_match', 'artist_credits_secondary')
