...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CartItemTextOption'
        db.create_table('shop_simplevariations_cartitemtextoption', (
        ...
        db.send_create_signal('shop_simplevariations', ['CartItemTextOption'])


    def backwards(self, orm):
        
        # Deleting model 'CartItemTextOption'
        db.delete_table('shop_simplevariations_cartitemtextoption')
