...
def confirmed_email_notification(sender, **kwargs):
    print 'confirmed_email_notification'
    """
    ...
    subject = loader.render_to_string(
        subject_template_name,order
    )
    subject = subject.join(subject.splitlines())
    
    body = loader.render_to_string(
        body_template_name, { 'order': order }
    )
...
def payment_instructions_email_notification(sender, **kwargs):
    print 'payment_instructions_email_notification'
    """
...
shipped.connect(payment_instructions_email_notification)
