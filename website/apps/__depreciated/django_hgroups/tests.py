...
class UserTestCase(TestCase):
    ...
    def test_get_all_groups(self):
        ...
        # user_2 should be member of all 4 groups.
    ...
    def test_has_perm(self):
        """
        Test if permissions attached to parent groups are inherited by the
        user's group.
        """

        user_1 = User.objects.get(username = 'user_1')
        self.assertTrue(user_1.has_perm('perm_1'))
        self.assertTrue(user_1.has_perm('perm_2'))
        self.assertFalse(user_1.has_perm('perm_3'))
        self.assertFalse(user_1.has_perm('perm_4'))

        user_2 = User.objects.get(username = 'user_2')
        self.assertTrue(user_2.has_perm('perm_1'))
        self.assertTrue(user_2.has_perm('perm_2'))
        self.assertTrue(user_2.has_perm('perm_3'))
        self.assertTrue(user_2.has_perm('perm_4'))
