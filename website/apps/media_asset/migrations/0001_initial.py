        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filesize",
                    models.PositiveIntegerField(
                        null=True, verbose_name="Filesize", blank=True
                    ),
                ),
                ...
                (
                    "media",
                    models.ForeignKey(
                        related_name="formats", to="alibrary.Media", null=True
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=64,
                        db_index=True,
                        choices=[("w", "Waveform"), ("s", "Spectrogram")],
                    ),
                ),
                ("accessed", models.DateTimeField(auto_now_add=True)),
                ("media_uuid", models.UUIDField(null=True, blank=True)),
                (
                    "media",
                    models.ForeignKey(
                        related_name="waveforms", to="alibrary.Media", null=True
                    ),
                ),
            ],
