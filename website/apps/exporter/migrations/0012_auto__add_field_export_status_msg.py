...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Export.status_msg'
        db.add_column('exporter_export', 'status_msg',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Export.status_msg'
        db.delete_column('exporter_export', 'status_msg')
    ...
    models = {
        ...
        'exporter.export': {
            ...
            'status_msg': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
