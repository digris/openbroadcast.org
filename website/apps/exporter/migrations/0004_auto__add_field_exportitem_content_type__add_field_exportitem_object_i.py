...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExportItem.content_type'
        db.add_column('exporter_exportitem', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'ExportItem.object_id'
        db.add_column('exporter_exportitem', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExportItem.content_type'
        db.delete_column('exporter_exportitem', 'content_type_id')

        # Deleting field 'ExportItem.object_id'
        db.delete_column('exporter_exportitem', 'object_id')
