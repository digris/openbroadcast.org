...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Export'
        db.create_table('exporter_export', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exports', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ...
        db.send_create_signal('exporter', ['Export'])

        # Adding model 'ExportItem'
        db.create_table('exporter_exportitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('export_session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', null=True, to=orm['exporter.Export'])),
            ('status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('exporter', ['ExportItem'])


    def backwards(self, orm):
        # Deleting model 'Export'
        db.delete_table('exporter_export')

        # Deleting model 'ExportItem'
        db.delete_table('exporter_exportitem')
    ...
    models = {
        ...
        'exporter.exportitem': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'export_session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'null': 'True', 'to': "orm['exporter.Export']"}),
