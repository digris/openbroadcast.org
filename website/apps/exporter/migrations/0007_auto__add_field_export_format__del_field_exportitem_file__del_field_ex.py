...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Export.format'
        db.add_column('exporter_export', 'format',
                      self.gf('django.db.models.fields.CharField')(default='mp3', max_length=4),
                      keep_default=False)

        # Deleting field 'ExportItem.file'
        db.delete_column('exporter_exportitem', 'file')

        # Deleting field 'ExportItem.filename'
        db.delete_column('exporter_exportitem', 'filename')


    def backwards(self, orm):
        # Deleting field 'Export.format'
        db.delete_column('exporter_export', 'format')

        # Adding field 'ExportItem.file'
        db.add_column('exporter_exportitem', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExportItem.filename'
        db.add_column('exporter_exportitem', 'filename',
    ...
    models = {
        ...
        'exporter.export': {
            ...
            'format': ('django.db.models.fields.CharField', [], {'default': "'mp3'", 'max_length': '4'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
