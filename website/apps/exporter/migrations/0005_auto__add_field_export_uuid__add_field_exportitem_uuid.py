...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Export.uuid'
        db.add_column('exporter_export', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'ExportItem.uuid'
        db.add_column('exporter_exportitem', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Export.uuid'
        db.delete_column('exporter_export', 'uuid')

        # Deleting field 'ExportItem.uuid'
        db.delete_column('exporter_exportitem', 'uuid')
