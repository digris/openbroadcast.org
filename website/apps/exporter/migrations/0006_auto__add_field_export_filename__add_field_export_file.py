...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Export.filename'
        db.add_column('exporter_export', 'filename',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Export.file'
        db.add_column('exporter_export', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Export.filename'
        db.delete_column('exporter_export', 'filename')

        # Deleting field 'Export.file'
        db.delete_column('exporter_export', 'file')
