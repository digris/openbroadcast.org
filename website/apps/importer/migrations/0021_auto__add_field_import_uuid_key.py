...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Import.uuid_key'
        db.add_column('importer_import', 'uuid_key',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Import.uuid_key'
        db.delete_column('importer_import', 'uuid_key')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bf3c7e4c-56ce-45e1-812f-b1fbc644817a'", 'max_length': '36'})
        },
        'alibrary.media': {
        ...
        'importer.import': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'uuid_key': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'})
        },
        'importer.importfile': {
