...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportFile.file'
        db.alter_column('importer_importfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'ImportFile.file'
        db.alter_column('importer_importfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'aa87db0c-b86f-4242-99d5-7ccf306d9680'", 'max_length': '36'})
        },
        'alibrary.media': {
