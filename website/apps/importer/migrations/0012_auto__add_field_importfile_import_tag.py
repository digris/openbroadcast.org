...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.import_tag'
        db.add_column('importer_importfile', 'import_tag',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.import_tag'
        db.delete_column('importer_importfile', 'import_tag')
