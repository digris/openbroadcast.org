...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.settings'
        db.add_column('importer_importfile', 'settings',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.settings'
        db.delete_column('importer_importfile', 'settings')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6578959e-ead3-49d7-9d91-7e9fba61bab9'", 'max_length': '36'})
        },
        'alibrary.media': {
