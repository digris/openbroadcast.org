...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.results_tag'
        db.add_column('importer_importfile', 'results_tag',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.results_musicbrainz'
        db.add_column('importer_importfile', 'results_musicbrainz',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.results_discogs'
        db.add_column('importer_importfile', 'results_discogs',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.results_tag'
        db.delete_column('importer_importfile', 'results_tag')

        # Deleting field 'ImportFile.results_musicbrainz'
        db.delete_column('importer_importfile', 'results_musicbrainz')

        # Deleting field 'ImportFile.results_discogs'
        db.delete_column('importer_importfile', 'results_discogs')
