...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.mimetype'
        db.add_column('importer_importfile', 'mimetype',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.mimetype'
        db.delete_column('importer_importfile', 'mimetype')
