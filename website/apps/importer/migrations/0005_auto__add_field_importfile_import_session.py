...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.import_session'
        db.add_column('importer_importfile', 'import_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['importer.Import'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.import_session'
        db.delete_column('importer_importfile', 'import_session_id')
    ...
    models = {
        ...
        'importer.importfile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['importer.Import']", 'null': 'True'}),
            'status': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        }
    }
