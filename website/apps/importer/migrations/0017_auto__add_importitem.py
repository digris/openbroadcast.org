...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImportItem'
        db.create_table('importer_importitem', (
        ...
        db.send_create_signal('importer', ['ImportItem'])


    def backwards(self, orm):
        # Deleting model 'ImportItem'
        db.delete_table('importer_importitem')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ec396bef-b155-4326-b793-dcdd0d69e809'", 'max_length': '36'})
        },
        'alibrary.media': {
