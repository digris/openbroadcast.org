...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Import.uuid'
        db.add_column('importer_import', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.uuid'
        db.add_column('importer_importfile', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Import.uuid'
        db.delete_column('importer_import', 'uuid')

        # Deleting field 'ImportFile.uuid'
        db.delete_column('importer_importfile', 'uuid')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'78f7da27-e96a-4808-9caf-818d148dac2c'", 'max_length': '36'})
        },
        'alibrary.media': {
