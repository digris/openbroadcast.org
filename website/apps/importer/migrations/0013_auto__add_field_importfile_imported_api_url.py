...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.imported_api_url'
        db.add_column('importer_importfile', 'imported_api_url',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.imported_api_url'
        db.delete_column('importer_importfile', 'imported_api_url')
