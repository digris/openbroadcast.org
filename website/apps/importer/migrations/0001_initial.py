    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='web', max_length=10, choices=[('web', 'Web Interface'), ('api', 'API'), ('fs', 'Filesystem')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=importer.models.UnuspiciousStorage(), max_length=1024, upload_to=importer.models.clean_upload_path)),
                ('mimetype', models.CharField(max_length=100, null=True, blank=True)),
                ('messages', django_extensions.db.fields.json.JSONField(default=None, null=True, blank=True)),
                ('settings', django_extensions.db.fields.json.JSONField(default=dict, null=True, blank=True)),
                ('results_tag', django_extensions.db.fields.json.JSONField(default=dict, null=True, blank=True)),
                ...
                ('results_acoustid', django_extensions.db.fields.json.JSONField(default=dict, null=True, blank=True)),
                ...
                ('results_musicbrainz', django_extensions.db.fields.json.JSONField(default=dict, null=True, blank=True)),
                ...
                ('results_discogs', django_extensions.db.fields.json.JSONField(default=dict, null=True, blank=True)),
                ('import_tag', django_extensions.db.fields.json.JSONField(default=dict, null=True, blank=True)),
