...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportItem.import_session'
        db.add_column('importer_importitem', 'import_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='importitem_set', null=True, to=orm['importer.Import']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportItem.import_session'
        db.delete_column('importer_importitem', 'import_session_id')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9bb680e0-fdf1-4c89-bc22-e675794cc69f'", 'max_length': '36'})
        },
        'alibrary.media': {
