...
class ImportCreateModelForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout = Layout(
            Fieldset(_("Information"), Field("notes", css_class="input-xxlarge")),
            Fieldset(
                _("Terms & Legal"), Field("agree_terms"), Field("agree_documentation")
            ),
            FormActions(
                HTML(
                ...
                HTML(
                    '<button type="reset" name="reset" value="reset" class="reset btn btn-abort pull-right"><i class="icon-trash"></i> Cancel</button>'
                ),
            ),
        )
    ...
    agree_documentation = forms.BooleanField(
        label=mark_safe(
            ...
            % (
                ...
                _("ducumentation"),
                _(" and understand how Importing works"),
            )
        ),
        initial=False,
        required=True,
