...
class ImportAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status",)
    readonly_fields = ("created", "updated", "notes")
...
class ImportFileAdmin(admin.ModelAdmin):
    ...
    list_display = ("created", "filename", "media", "error", "status", "mimetype")

    search_fields = ("id", "filename", "media__name")
...
class ImportItemAdmin(admin.ModelAdmin):
    ...
    list_display = ("import_session", "content_type", "object_id", "content_object")
