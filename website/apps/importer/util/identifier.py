...
class Identifier(object):
        ...
        try:
            ...
            if "media_mb_id" in metadata and metadata["media_mb_id"]:
                ...
                qs = Media.objects.filter(
                    relations__url__contains="/recording/{}".format(
    ...
    def id_by_fprint(self, file):
        ...
        results = FprintAPIClient().identify(
            fprint=fprint, min_score=0.12, duration_tolerance=3.0
        )
    ...
    def get_aid(self, file):
        ...
        try:
            ...
            for d in data:
                ...
                if i == 0:
                    selected = True
                t = {"score": d[0], "id": d[1], "selected": selected}
            ...
            if release["id"] in completed_releases:
                ...
                if "label-info" in result and len(result["label-info"]) == 1:
                    ...
                    if "catalog-number" in result["label-info"][0]:
                        release["catalog-number"] = result["label-info"][0][
                            "catalog-number"
                        ]
    ...
    def complete_musicbrainz(self, results):
        ...
        for rg in rgs:
            ...
            result = musicbrainzngs.get_release_by_id(
                id=first_release["id"], includes=["labels", "url-rels", "recordings"]
            )
                ...
                try:
                    for relation in relations:
                        if relation["type"] == "discogs":
                            ...
                            rel["discogs_image"] = discogs_image_by_url(
