...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShortcutCollection.title'
        db.add_column('shortcutter_shortcutcollection', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShortcutCollection.title'
        db.delete_column('shortcutter_shortcutcollection', 'title')
