...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shortcut.position'
        db.add_column('shortcutter_shortcut', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shortcut.position'
        db.delete_column('shortcutter_shortcut', 'position')
    ...
    models = {
        ...
        'shortcutter.shortcut': {
            'Meta': {'ordering': "('-position', 'name')", 'object_name': 'Shortcut'},
