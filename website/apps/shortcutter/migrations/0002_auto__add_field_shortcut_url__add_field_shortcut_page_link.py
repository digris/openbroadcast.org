...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shortcut.url'
        db.add_column('shortcutter_shortcut', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Shortcut.page_link'
        db.add_column('shortcutter_shortcut', 'page_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shortcut.url'
        db.delete_column('shortcutter_shortcut', 'url')

        # Deleting field 'Shortcut.page_link'
        db.delete_column('shortcutter_shortcut', 'page_link_id')
