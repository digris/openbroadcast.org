...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shortcut.description'
        db.add_column('shortcutter_shortcut', 'description',
                      self.gf('lib.fields.extra.MarkdownTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Shortcut.description_html'
        db.add_column('shortcutter_shortcut', 'description_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shortcut.description'
        db.delete_column('shortcutter_shortcut', 'description')

        # Deleting field 'Shortcut.description_html'
        db.delete_column('shortcutter_shortcut', 'description_html')
