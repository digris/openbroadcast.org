...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shortcut.key'
        db.add_column('shortcutter_shortcut', 'key',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Shortcut.name'
        db.alter_column('shortcutter_shortcut', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):
        # Deleting field 'Shortcut.key'
        db.delete_column('shortcutter_shortcut', 'key')


        # Changing field 'Shortcut.name'
        db.alter_column('shortcutter_shortcut', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
