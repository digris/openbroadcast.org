...
from api_extras.authentication import ApiKeyEmailAuthentication
...
from .utils import reset_password, send_activation_email
...
class UserResource(ModelResource):
    ...
    """
    profile = fields.ForeignKey('member.api.UserProfileResource', 'profile', null=True, full=True)
    ...
    class Meta:
        ...
        excludes = ['id', 'username', 'password', 'is_active', 'is_staff', 'is_superuser', 'date_of_birth', 'height', 'weight', 'measurement_system', 'first_name', 'last_name']
        authentication = MultiAuthentication(ApiKeyEmailAuthentication(), )
    ...
    def dehydrate(self, bundle):
        ...
        try:
            bundle.data['device_uri'] = Device.objects.get(profiles__in=[bundle.obj.profile,]).get_api_url()
        except:
            bundle.data['device_uri'] = None

        try:
            bundle.data['full_name'] = bundle.obj.profile.full_name
        except:
    ...
    def login(self, request, **kwargs):
        ...
        log.info('successfully login for %s' % email)
...
class UserProfileResource(ModelResource):
    ...
    device = fields.ForeignKey('device.api.DeviceResource', 'device', null=True, full=True)
