...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.on_air_type'
        db.add_column('abcast_channel', 'on_air_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channel.on_air_id'
        db.add_column('abcast_channel', 'on_air_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.on_air_type'
        db.delete_column('abcast_channel', 'on_air_type_id')

        # Deleting field 'Channel.on_air_id'
        db.delete_column('abcast_channel', 'on_air_id')
