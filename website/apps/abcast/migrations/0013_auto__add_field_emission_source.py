...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emission.source'
        db.add_column('abcast_emission', 'source',
                      self.gf('django.db.models.fields.CharField')(default='user', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emission.source'
        db.delete_column('abcast_emission', 'source')
