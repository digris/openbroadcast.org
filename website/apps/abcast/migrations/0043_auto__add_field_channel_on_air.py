...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.on_air'
        db.add_column('abcast_channel', 'on_air',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.on_air'
        db.delete_column('abcast_channel', 'on_air')
    ...
    models = {
        ...
        'abcast.channel': {
            ...
            'on_air': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
