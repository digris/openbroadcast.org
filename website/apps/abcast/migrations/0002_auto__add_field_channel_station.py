...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.station'
        db.add_column('abcast_channel', 'station',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abcast.Station'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.station'
        db.delete_column('abcast_channel', 'station_id')
