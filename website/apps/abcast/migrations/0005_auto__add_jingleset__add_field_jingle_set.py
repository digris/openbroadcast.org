...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JingleSet'
        db.create_table('abcast_jingleset', (
        ...
        db.send_create_signal('abcast', ['JingleSet'])

        # Adding field 'Jingle.set'
        db.add_column('abcast_jingle', 'set',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='jingle_set', null=True, on_delete=models.SET_NULL, to=orm['abcast.JingleSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'JingleSet'
        db.delete_table('abcast_jingleset')

        # Deleting field 'Jingle.set'
        db.delete_column('abcast_jingle', 'set_id')
