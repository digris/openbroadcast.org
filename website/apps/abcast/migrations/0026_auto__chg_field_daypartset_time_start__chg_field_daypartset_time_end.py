...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DaypartSet.time_start'
        db.alter_column('abcast_daypartset', 'time_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'DaypartSet.time_end'
        db.alter_column('abcast_daypartset', 'time_end', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'DaypartSet.time_start'
        db.alter_column('abcast_daypartset', 'time_start', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'DaypartSet.time_end'
        db.alter_column('abcast_daypartset', 'time_end', self.gf('django.db.models.fields.DateTimeField')(null=True))
