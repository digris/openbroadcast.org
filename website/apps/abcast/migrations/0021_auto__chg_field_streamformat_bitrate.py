...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StreamFormat.bitrate'
        db.alter_column('abcast_streamformat', 'bitrate', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'StreamFormat.bitrate'
        db.alter_column('abcast_streamformat', 'bitrate', self.gf('django.db.models.fields.CharField')(max_length=12))
