...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.website'
        db.add_column('abcast_station', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=256, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.website'
        db.delete_column('abcast_station', 'website')
    ...
    models = {
        ...
        'abcast.station': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '256', 'null': 'True'}),
