...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreamServer.formats'
        db.add_column('abcast_streamserver', 'formats',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abcast.StreamFormat'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StreamServer.formats'
        db.delete_column('abcast_streamserver', 'formats_id')
    ...
    models = {
        ...
        'abcast.streamserver': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'formats': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['abcast.StreamFormat']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
