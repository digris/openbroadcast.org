...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StationMembers'
        db.create_table('abcast_stationmembers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='station_membership', to=orm['auth.User'])),
            ('station', self.gf('django.db.models.fields.related.ForeignKey')(related_name='station_members', to=orm['abcast.Station'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='station_roles', null=True, to=orm['abcast.Role'])),
        ))
        db.send_create_signal('abcast', ['StationMembers'])

        # Adding model 'Role'
        db.create_table('abcast_role', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('abcast', ['Role'])


    def backwards(self, orm):
        # Deleting model 'StationMembers'
        db.delete_table('abcast_stationmembers')

        # Deleting model 'Role'
        db.delete_table('abcast_role')
    ...
    models = {
        ...
        'abcast.stationmembers': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'station_roles'", 'null': 'True', 'to': "orm['abcast.Role']"}),
            'station': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'station_members'", 'to': "orm['abcast.Station']"}),
