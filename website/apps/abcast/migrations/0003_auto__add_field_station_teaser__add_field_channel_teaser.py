...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.teaser'
        db.add_column('abcast_station', 'teaser',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channel.teaser'
        db.add_column('abcast_channel', 'teaser',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.teaser'
        db.delete_column('abcast_station', 'teaser')

        # Deleting field 'Channel.teaser'
        db.delete_column('abcast_channel', 'teaser')
