...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnAirPlugin.show_channel_info'
        db.add_column('cmsplugin_onairplugin', 'show_channel_info',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnAirPlugin.show_channel_info'
        db.delete_column('cmsplugin_onairplugin', 'show_channel_info')
