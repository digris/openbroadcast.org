...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'abcast.daypart': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'weekdays': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['abcast.Weekay']", 'null': 'True', 'blank': 'True'})
        },
        'abcast.daypartset': {
        ...
        'abcast.weekay': {
            'Meta': {'ordering': "('day',)", 'object_name': 'Weekay'},
