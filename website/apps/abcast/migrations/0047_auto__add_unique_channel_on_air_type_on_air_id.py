...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Channel', fields ['on_air_type', 'on_air_id']
        db.create_unique('abcast_channel', ['on_air_type_id', 'on_air_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Channel', fields ['on_air_type', 'on_air_id']
        db.delete_unique('abcast_channel', ['on_air_type_id', 'on_air_id'])
