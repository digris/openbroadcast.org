...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Daypart.mood'
        db.add_column('abcast_daypart', 'mood',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Daypart.sound'
        db.add_column('abcast_daypart', 'sound',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Daypart.talk'
        db.add_column('abcast_daypart', 'talk',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Daypart.mood'
        db.delete_column('abcast_daypart', 'mood')

        # Deleting field 'Daypart.sound'
        db.delete_column('abcast_daypart', 'sound')

        # Deleting field 'Daypart.talk'
        db.delete_column('abcast_daypart', 'talk')
