...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Weekay'
        db.delete_table('abcast_weekay')

        # Adding model 'Weekday'
        db.create_table('abcast_weekday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=1)),
        ))
        db.send_create_signal('abcast', ['Weekday'])

        # Removing M2M table for field weekdays on 'Daypart'
        db.delete_table('abcast_daypart_weekdays')


    def backwards(self, orm):
        # Adding model 'Weekay'
        db.create_table('abcast_weekay', (
            ('day', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=1)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('abcast', ['Weekay'])

        # Deleting model 'Weekday'
        db.delete_table('abcast_weekday')

        # Adding M2M table for field weekdays on 'Daypart'
        db.create_table('abcast_daypart_weekdays', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('daypart', models.ForeignKey(orm['abcast.daypart'], null=False)),
            ('weekay', models.ForeignKey(orm['abcast.weekay'], null=False))
        ))
        db.create_unique('abcast_daypart_weekdays', ['daypart_id', 'weekay_id'])
