...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('abcast_broadcast', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scheduler_broadcasts', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ))
        db.send_create_signal('abcast', ['Broadcast'])


    def backwards(self, orm):
        # Deleting model 'Broadcast'
        db.delete_table('abcast_broadcast')
