...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.rtmp_app'
        db.add_column('abcast_channel', 'rtmp_app',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channel.rtmp_path'
        db.add_column('abcast_channel', 'rtmp_path',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.rtmp_app'
        db.delete_column('abcast_channel', 'rtmp_app')

        # Deleting field 'Channel.rtmp_path'
        db.delete_column('abcast_channel', 'rtmp_path')
