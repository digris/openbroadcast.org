...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OnAirPlugin'
        db.create_table('cmsplugin_onairplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['abcast.Channel'])),
        ))
        db.send_create_signal('abcast', ['OnAirPlugin'])


    def backwards(self, orm):
        # Deleting model 'OnAirPlugin'
        db.delete_table('cmsplugin_onairplugin')
