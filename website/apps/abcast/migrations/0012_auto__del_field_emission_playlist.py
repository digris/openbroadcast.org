...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Emission.playlist'
        db.delete_column('abcast_emission', 'playlist_id')


    def backwards(self, orm):
        # Adding field 'Emission.playlist'
        db.add_column('abcast_emission', 'playlist',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='scheduler_emissions', null=True, to=orm['alibrary.Playlist'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
