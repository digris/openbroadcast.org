...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreamServer.mountpoint'
        db.add_column('abcast_streamserver', 'mountpoint',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StreamServer.mountpoint'
        db.delete_column('abcast_streamserver', 'mountpoint')
