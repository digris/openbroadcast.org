...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StationMembers.role'
        db.delete_column('abcast_stationmembers', 'role_id')


    def backwards(self, orm):
        # Adding field 'StationMembers.role'
        db.add_column('abcast_stationmembers', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abcast.Role'], null=True, blank=True),
                      keep_default=False)
