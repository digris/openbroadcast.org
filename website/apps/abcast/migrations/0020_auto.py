...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field formats on 'StreamServer'
        db.create_table('abcast_streamserver_formats', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('streamserver', models.ForeignKey(orm['abcast.streamserver'], null=False)),
            ('streamformat', models.ForeignKey(orm['abcast.streamformat'], null=False))
        ))
        db.create_unique('abcast_streamserver_formats', ['streamserver_id', 'streamformat_id'])


    def backwards(self, orm):
        # Removing M2M table for field formats on 'StreamServer'
        db.delete_table('abcast_streamserver_formats')
    ...
    models = {
        ...
        'abcast.streamformat': {
            ...
            'bitrate': ('django.db.models.fields.CharField', [], {'default': "'icecast2'", 'max_length': '12'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
