...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StreamFormat'
        db.create_table('abcast_streamformat', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='mp3', max_length=12)),
            ('bitrate', self.gf('django.db.models.fields.CharField')(default='icecast2', max_length=12)),
        ))
        db.send_create_signal('abcast', ['StreamFormat'])

        # Adding field 'StreamServer.active'
        db.add_column('abcast_streamserver', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StreamFormat'
        db.delete_table('abcast_streamformat')

        # Deleting field 'StreamServer.active'
        db.delete_column('abcast_streamserver', 'active')
