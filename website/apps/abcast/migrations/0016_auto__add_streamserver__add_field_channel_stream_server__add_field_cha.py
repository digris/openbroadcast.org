...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StreamServer'
        db.create_table('abcast_streamserver', (
            ...
            ('host', self.gf('django.db.models.fields.URLField')(max_length=256, null=True)),
            ('source_pass', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('admin_pass', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='icecast2', max_length=12)),
        ))
        db.send_create_signal('abcast', ['StreamServer'])

        # Adding field 'Channel.stream_server'
        db.add_column('abcast_channel', 'stream_server',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abcast.StreamServer'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Channel.mount'
        db.add_column('abcast_channel', 'mount',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StreamServer'
        db.delete_table('abcast_streamserver')

        # Deleting field 'Channel.stream_server'
        db.delete_column('abcast_channel', 'stream_server_id')

        # Deleting field 'Channel.mount'
        db.delete_column('abcast_channel', 'mount')
