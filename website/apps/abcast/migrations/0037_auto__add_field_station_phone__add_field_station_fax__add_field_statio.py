...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.phone'
        db.add_column('abcast_station', 'phone',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Station.fax'
        db.add_column('abcast_station', 'fax',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Station.address1'
        db.add_column('abcast_station', 'address1',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Station.address2'
        db.add_column('abcast_station', 'address2',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Station.city'
        db.add_column('abcast_station', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Station.zip'
        db.add_column('abcast_station', 'zip',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Station.country'
        db.add_column('abcast_station', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['l10n.Country'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.phone'
        db.delete_column('abcast_station', 'phone')

        # Deleting field 'Station.fax'
        db.delete_column('abcast_station', 'fax')

        # Deleting field 'Station.address1'
        db.delete_column('abcast_station', 'address1')

        # Deleting field 'Station.address2'
        db.delete_column('abcast_station', 'address2')

        # Deleting field 'Station.city'
        db.delete_column('abcast_station', 'city')

        # Deleting field 'Station.zip'
        db.delete_column('abcast_station', 'zip')

        # Deleting field 'Station.country'
        db.delete_column('abcast_station', 'country_id')
