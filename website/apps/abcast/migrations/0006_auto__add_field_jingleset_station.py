...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JingleSet.station'
        db.add_column('abcast_jingleset', 'station',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='jingleset_station', null=True, on_delete=models.SET_NULL, to=orm['abcast.Station']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JingleSet.station'
        db.delete_column('abcast_jingleset', 'station_id')
