...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('abcast_station', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='stream', max_length=12)),
            ('main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='station_main_image', null=True, to=orm['filer.Image'])),
        ...
        db.send_create_signal('abcast', ['Station'])

        # Adding model 'Channel'
        db.create_table('abcast_channel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ...
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='name', overwrite=False)),
            ('type', self.gf('django.db.models.fields.CharField')(default='stream', max_length=12)),
            ('stream_url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('description', self.gf('lib.fields.extra.MarkdownTextField')(null=True, blank=True)),
            ('description_html', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('abcast', ['Channel'])


    def backwards(self, orm):
        # Deleting model 'Station'
        db.delete_table('abcast_station')

        # Deleting model 'Channel'
        db.delete_table('abcast_channel')
