...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django_extensions.db.fields.AutoSlugField(
                        populate_from="name", editable=False, blank=True
                    ),
                ),
                (
                    "type",
                    models.CharField(
                        ...
                        max_length=12,
                        verbose_name="Type",
                        choices=[("stream", "Stream"), ("djmon", "DJ-Monitor")],
                    ),
                ),
                (
                    "stream_url",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, choices=[(0, "0"), (1, "1"), (2, "2"), (3, "3")]
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.PositiveIntegerField(
                        default=0, choices=[(0, "Waiting"), (1, "Done"), (2, "Error")]
                    ),
                ),
                (
                    "color",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=12,
                        verbose_name="Source",
                        choices=[("user", "User"), ("autopilot", "Autopilot")],
                    ),
                ),
                ...
                (
                    "channel",
                    models.ForeignKey(
                        related_name="scheduler_emissions",
                        on_delete=django.db.models.deletion.SET_NULL,
                        blank=True,
                        to="abcast.Channel",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "On Air", "verbose_name_plural": "On Air"},
        ),
        migrations.CreateModel(
            name="Role",
            fields=[
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="memgership_roles", to="abcast.Role", blank=True
                    ),
                ),
                ...
                (
                    "user",
                    models.ForeignKey(
                        related_name="station_membership", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to=settings.AUTH_USER_MODEL, through="abcast.StationMembers", blank=True
            ),
        ),
        migrations.AddField(
            model_name="daypart",
