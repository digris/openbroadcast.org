...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreamServer.meta_prefix'
        db.add_column('abcast_streamserver', 'meta_prefix',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StreamServer.meta_prefix'
        db.delete_column('abcast_streamserver', 'meta_prefix')
    ...
    models = {
        ...
        'abcast.streamserver': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta_prefix': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
