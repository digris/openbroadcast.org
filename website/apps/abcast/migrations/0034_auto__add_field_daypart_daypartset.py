...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Daypart.daypartset'
        db.add_column('abcast_daypart', 'daypartset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abcast.DaypartSet'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Daypart.daypartset'
        db.delete_column('abcast_daypart', 'daypartset_id')
