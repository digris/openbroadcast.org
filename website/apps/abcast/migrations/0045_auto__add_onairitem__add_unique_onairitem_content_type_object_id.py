...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OnAirItem'
        db.create_table('abcast_onairitem', (
        ...
        db.send_create_signal('abcast', ['OnAirItem'])

        # Adding unique constraint on 'OnAirItem', fields ['content_type', 'object_id']
        db.create_unique('abcast_onairitem', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'OnAirItem', fields ['content_type', 'object_id']
        db.delete_unique('abcast_onairitem', ['content_type_id', 'object_id'])

        # Deleting model 'OnAirItem'
        db.delete_table('abcast_onairitem')
