...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreamServer.source_user'
        db.add_column('abcast_streamserver', 'source_user',
                      self.gf('django.db.models.fields.CharField')(default='source', max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StreamServer.admin_user'
        db.add_column('abcast_streamserver', 'admin_user',
                      self.gf('django.db.models.fields.CharField')(default='admin', max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StreamServer.source_user'
        db.delete_column('abcast_streamserver', 'source_user')

        # Deleting field 'StreamServer.admin_user'
        db.delete_column('abcast_streamserver', 'admin_user')
    ...
    models = {
        ...
        'abcast.channel': {
            'Meta': {'ordering': "('name',)", 'unique_together': "(('on_air_type', 'on_air_id'),)", 'object_name': 'Channel'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'on_air_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'on_air_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'rtmp_app': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'rtmp_path': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        'abcast.daypart': {
            'Meta': {'ordering': "('position', 'time_start')", 'object_name': 'Daypart'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'abcast.onairitem': {
            'Meta': {'unique_together': "(('content_type', 'object_id'),)", 'object_name': 'OnAirItem'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        'abcast.streamserver': {
            ...
            'admin_user': ('django.db.models.fields.CharField', [], {'default': "'admin'", 'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta_prefix': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'mountpoint': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'source_pass': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'source_user': ('django.db.models.fields.CharField', [], {'default': "'source'", 'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        'alibrary.relation': {
            ...
            'service': ('django.db.models.fields.CharField', [], {'default': "'generic'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'l10n.country': {
            'Meta': {'ordering': "('iso2_code',)", 'object_name': 'Country'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
