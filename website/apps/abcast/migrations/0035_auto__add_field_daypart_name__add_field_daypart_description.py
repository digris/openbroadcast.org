...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Daypart.name'
        db.add_column('abcast_daypart', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Daypart.description'
        db.add_column('abcast_daypart', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Daypart.name'
        db.delete_column('abcast_daypart', 'name')

        # Deleting field 'Daypart.description'
        db.delete_column('abcast_daypart', 'description')
