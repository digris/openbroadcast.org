...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Daypart.day'
        db.delete_column('abcast_daypart', 'day')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Daypart.day'
        db.add_column('abcast_daypart', 'day',
                      self.gf('weekday_field.fields.WeekdayField')(max_length=14, null=True),
                      keep_default=False)
