...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emission.content_type'
        db.add_column('abcast_emission', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Emission.object_id'
        db.add_column('abcast_emission', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emission.content_type'
        db.delete_column('abcast_emission', 'content_type_id')

        # Deleting field 'Emission.object_id'
        db.delete_column('abcast_emission', 'object_id')
