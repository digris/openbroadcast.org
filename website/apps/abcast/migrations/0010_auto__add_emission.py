...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('abcast_emission', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='jingle', max_length=12)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scheduler_emissions', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scheduler_emissions', null=True, on_delete=models.SET_NULL, to=orm['abcast.Channel'])),
            ('playlist', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scheduler_emissions', null=True, on_delete=models.SET_NULL, to=orm['alibrary.Playlist'])),
        ))
        db.send_create_signal('abcast', ['Emission'])


    def backwards(self, orm):
        # Deleting model 'Emission'
        db.delete_table('abcast_emission')
    ...
    models = {
        ...
        'abcast.emission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
            'playlist': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'scheduler_emissions'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['alibrary.Playlist']"}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'name'", 'overwrite': 'True'}),
            'status': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'max_length': '2'}),
