...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JingleSet.main_image'
        db.add_column('abcast_jingleset', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='jingleset_main_image', null=True, to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JingleSet.main_image'
        db.delete_column('abcast_jingleset', 'main_image_id')
