...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DaypartSet'
        db.create_table('abcast_daypartset', (
            ...
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='daypartset_set', null=True, on_delete=models.SET_NULL, to=orm['abcast.Channel'])),
            ('time_start', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('abcast', ['DaypartSet'])

        # Adding M2M table for field dayparts on 'DaypartSet'
        db.create_table('abcast_daypartset_dayparts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('daypartset', models.ForeignKey(orm['abcast.daypartset'], null=False)),
            ('daypart', models.ForeignKey(orm['abcast.daypart'], null=False))
        ))
        db.create_unique('abcast_daypartset_dayparts', ['daypartset_id', 'daypart_id'])

        # Adding model 'Daypart'
        db.create_table('abcast_daypart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('day', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=1, null=True)),
            ('time_start', self.gf('django.db.models.fields.TimeField')()),
            ('time_end', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('abcast', ['Daypart'])


    def backwards(self, orm):
        # Deleting model 'DaypartSet'
        db.delete_table('abcast_daypartset')

        # Removing M2M table for field dayparts on 'DaypartSet'
        db.delete_table('abcast_daypartset_dayparts')

        # Deleting model 'Daypart'
        db.delete_table('abcast_daypart')
    ...
    models = {
        ...
        'abcast.daypartset': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'dayparts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['abcast.Daypart']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
