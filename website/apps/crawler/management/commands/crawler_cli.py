...
from ...workflows.musicbrainz import (
    ...
    label_crawl_musicbrainz,
    release_crawl_musicbrainz,
    media_crawl_musicbrainz,
)

from ...workflows.discogs import label_crawl_discogs
...
def crawl_viaf_isni(cache_for):
    ...
    qs = Artist.objects.filter(
        Q(isni_code__isnull=True) | Q(isni_code=""), relations__service="viaf"
    ).distinct()
