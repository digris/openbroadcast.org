...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FAQMultiListPlugin'
        db.create_table(u'cmsplugin_faqmultilistplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=7)),
        ))
        db.send_create_signal('faq', ['FAQMultiListPlugin'])


    def backwards(self, orm):
        # Deleting model 'FAQMultiListPlugin'
        db.delete_table(u'cmsplugin_faqmultilistplugin')
