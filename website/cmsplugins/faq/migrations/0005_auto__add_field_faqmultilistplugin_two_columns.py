...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FAQMultiListPlugin.two_columns'
        db.add_column(u'cmsplugin_faqmultilistplugin', 'two_columns',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FAQMultiListPlugin.two_columns'
        db.delete_column(u'cmsplugin_faqmultilistplugin', 'two_columns')
    ...
    models = {
        ...
        'faq.faq': {
            'Meta': {'ordering': "['-weight', 'question']", 'object_name': 'FAQ'},
        ...
        'faq.faqmultilistplugin': {
            ...
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            'two_columns': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'faq.faqplugin': {
