...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Soundcloud.url'
        db.add_column('cmsplugin_soundcloud', 'url',
                      self.gf('django.db.models.fields.URLField')(default='http://www.hulahoneys.net/', max_length=512),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Soundcloud.url'
        db.delete_column('cmsplugin_soundcloud', 'url')
