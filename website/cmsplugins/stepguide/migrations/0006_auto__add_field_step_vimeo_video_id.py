...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Step.vimeo_video_id'
        db.add_column('stepguide_step', 'vimeo_video_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Step.vimeo_video_id'
        db.delete_column('stepguide_step', 'vimeo_video_id')
