...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Step.hint_type'
        db.add_column('stepguide_step', 'hint_type',
                      self.gf('django.db.models.fields.TextField')(default='info', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Step.hint_type'
        db.delete_column('stepguide_step', 'hint_type')
    ...
    models = {
        ...
        'stepguide.step': {
            ...
            'hint_type': ('django.db.models.fields.TextField', [], {'default': "'info'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
