...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Step.hint_type'
        db.alter_column('stepguide_step', 'hint_type', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Step.hint_type'
        db.alter_column('stepguide_step', 'hint_type', self.gf('django.db.models.fields.TextField')(max_length=10))
