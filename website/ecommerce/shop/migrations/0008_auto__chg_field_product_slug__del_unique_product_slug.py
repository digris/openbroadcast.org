...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_product', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from='name', overwrite=False))


    def backwards(self, orm):
        
        # Changing field 'Product.slug'
        db.alter_column('shop_product', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
