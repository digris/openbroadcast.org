...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleMap.route_planer_title'
        db.add_column('cmsplugin_googlemap', 'route_planer_title', orm['googlemap.googlemap:route_planer_title'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'GoogleMap.route_planer_title'
        db.delete_column('cmsplugin_googlemap', 'route_planer_title')
