...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleMap.route_planer'
        db.add_column('cmsplugin_googlemap', 'route_planer', orm['googlemap.googlemap:route_planer'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'GoogleMap.route_planer'
        db.delete_column('cmsplugin_googlemap', 'route_planer')
