...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.target'
        db.add_column('cmsplugin_link', 'target', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Link.target'
        db.delete_column('cmsplugin_link', 'target')
