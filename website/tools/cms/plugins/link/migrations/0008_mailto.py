...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.mailto'
        db.add_column('cmsplugin_link', 'mailto', orm['link.link:mailto'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'Link.mailto'
        db.delete_column('cmsplugin_link', 'mailto')
    ...
    models = {
        ...
        'link.link': {
            ...
            'mailto': ('models.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
