...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_inheritpageplaceholder', (
            ('cmsplugin_ptr', orm['inherit.InheritPagePlaceholder:cmsplugin_ptr']),
            ('parent_page', orm['inherit.InheritPagePlaceholder:parent_page']),
            ('from_language', orm['inherit.InheritPagePlaceholder:from_language']),
        ))
    ...
    models = {
        ...
        'inherit.inheritpageplaceholder': {
            ...
            'parent_page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']"})
        },
        'sites.site': {
