...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Video.width'
        db.rename_column('cmsplugin_video', '_i_width', 'width')

        # Renaming field 'Video.height'
        db.rename_column('cmsplugin_video', '_i_height', 'height')

    def backwards(self, orm):
        # Renaming field 'Video.width'
        db.rename_column('cmsplugin_video', 'width', '_i_width')

        # Renaming field 'Video.height'
        db.rename_column('cmsplugin_video', 'height', '_i_height')
