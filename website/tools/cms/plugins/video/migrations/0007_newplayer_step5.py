...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.height'
        # (to signature: django.db.models.fields.PositiveSmallIntegerField())
        db.alter_column('cmsplugin_video', 'height', orm['video.video:height'])
        
        # Changing field 'Video.width'
        # (to signature: django.db.models.fields.PositiveSmallIntegerField())
        db.alter_column('cmsplugin_video', 'width', orm['video.video:width'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.height'
        # (to signature: django.db.models.fields.PositiveSmallIntegerField(null=True))
        db.alter_column('cmsplugin_video', 'height', orm['video.video:height'])
