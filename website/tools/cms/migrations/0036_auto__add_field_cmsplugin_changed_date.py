...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CMSPlugin.changed_date'
        db.add_column('cms_cmsplugin', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(1969, 12, 31, 18, 0), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CMSPlugin.changed_date'
        db.delete_column('cms_cmsplugin', 'changed_date')
