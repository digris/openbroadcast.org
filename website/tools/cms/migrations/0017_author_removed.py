...
class Migration:
    ...
    def forwards(self, orm):
         # Deleting field 'PublicPage.author'
        db.delete_column('cms_publicpage', 'author_id')
    ...
    def backwards(self, orm):
         # Adding field 'PublicPage.author'
        db.add_column('cms_publicpage', 'author', orm['cms.publicpage:author'])
        
        # Adding field 'Page.author'
        db.add_column('cms_page', 'author', orm['cms.page:author'])
    
    
    models = {
        'cms.publiccmsplugin': {
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 58, 519348)'}),
        ...
        'auth.user': {
            'date_joined': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 3, 0, 724896)'}),
            ...
            'last_login': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 3, 0, 724789)'}),
        ...
        'cms.publictitle': {
            ...
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 59, 586892)'}),
        ...
        'cms.title': {
            'Meta': {'unique_together': "(('language', 'page'),)"},
            'application_urls': ('models.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 3, 2, 242309)'}),
            'has_url_overwrite': ('models.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
            'language': ('models.CharField', [], {'max_length': '5', 'db_index': 'True'}),
            'menu_title': ('models.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'cms.cmsplugin': {
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 3, 2, 677369)'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
        ...
        'cms.page': {
            ...
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 58, 167322)'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
        ...
        'cms.publicpage': {
            'changed_by': ('models.CharField', [], {'max_length': '70'}),
            'created_by': ('models.CharField', [], {'max_length': '70'}),
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 3, 3, 97808)'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
            'in_navigation': ('models.BooleanField', [], {'default': 'True', 'db_index': 'True', 'blank': 'True'}),
            'level': ('models.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('models.PositiveIntegerField', [], {'db_index': 'True'}),
