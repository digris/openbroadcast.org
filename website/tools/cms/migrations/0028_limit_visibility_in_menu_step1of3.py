...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.limit_visibility_in_menu'
        db.add_column('cms_page', 'limit_visibility_in_menu', self.gf('django.db.models.fields.SmallIntegerField')(default=None, null=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.limit_visibility_in_menu'
        db.delete_column('cms_page', 'limit_visibility_in_menu')
