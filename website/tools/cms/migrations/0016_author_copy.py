...
class Migration:
    ...
    def forwards(self, orm):
        if not db.dry_run:
            for page in orm.Page.objects.all():
                page.created_by = page.changed_by = page.author.username
                page.save()
    ...
    def backwards(self, orm):
        if not db.dry_run:
            for page in orm.Page.objects.all():
                page.author = orm.User.objects.get(username=page.created_by)
                page.save()
    
    
    models = {
        'cms.publiccmsplugin': {
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 48, 603789)'}),
        ...
        'auth.user': {
            'date_joined': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 50, 799051)'}),
            ...
            'last_login': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 50, 798915)'}),
        ...
        'cms.publictitle': {
            ...
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 49, 663763)'}),
        ...
        'cms.title': {
            'Meta': {'unique_together': "(('language', 'page'),)"},
            'application_urls': ('models.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 52, 262404)'}),
            'has_url_overwrite': ('models.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
            'language': ('models.CharField', [], {'max_length': '5', 'db_index': 'True'}),
            'menu_title': ('models.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'cms.cmsplugin': {
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 52, 681370)'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
        ...
        'cms.page': {
            ...
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 48, 267743)'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
        ...
        'cms.publicpage': {
            ...
            'created_by': ('models.CharField', [], {'max_length': '70'}),
            'author': ('models.ForeignKey', [], {'to': "orm['auth.User']"}),
            'creation_date': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 30, 5, 2, 53, 14970)'}),
            'id': ('models.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
            'in_navigation': ('models.BooleanField', [], {'default': 'True', 'db_index': 'True', 'blank': 'True'}),
            'level': ('models.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('models.PositiveIntegerField', [], {'db_index': 'True'}),
