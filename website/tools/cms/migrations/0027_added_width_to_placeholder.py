...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_placeholder', 'default_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Placeholder.default_width'
        db.delete_column('cms_placeholder', 'default_width')
