...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CMSPlugin.new_placeholder'
        db.add_column('cms_cmsplugin', 'new_placeholder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CMSPlugin.new_placeholder'
        db.delete_column('cms_cmsplugin', 'new_placeholder_id')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'new_placeholder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Placeholder']", 'null': 'True'}),
        ...
        'cms.page': {
            ...
            'placeholders': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cms.Placeholder']"}),
