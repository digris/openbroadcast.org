...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cms_title', 'language', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'CMSPlugin.language'
        db.alter_column('cms_cmsplugin', 'language', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Adding field 'Page.changed_date'
        db.add_column('cms_page', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(1969, 12, 31, 18, 0), blank=True), keep_default=False)

        # Changing field 'Page.creation_date'
        db.alter_column('cms_page', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Title.language'
        db.alter_column('cms_title', 'language', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'CMSPlugin.language'
        db.alter_column('cms_cmsplugin', 'language', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Deleting field 'Page.changed_date'
        db.delete_column('cms_page', 'changed_date')

        # Changing field 'Page.creation_date'
        db.alter_column('cms_page', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())
