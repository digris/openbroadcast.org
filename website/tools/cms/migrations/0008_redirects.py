...
class Migration:
    ...
    def forwards(self, orm):    
        # Adding field 'Title.redirect'
        db.add_column('cms_title', 'redirect', models.CharField(_("redirect"), max_length=255, null=True, blank=True))
    ...
    def backwards(self, orm):
        # Deleting field 'Title.redirect'
        db.delete_column('cms_title', 'redirect')
