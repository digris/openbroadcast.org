...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CMSPlugin.placeholder'
        db.delete_column('cms_cmsplugin', 'placeholder')
        
        # Renaming field 'CMSPlugin.new_placeholder' to 'CMSPlugin.placeholder'
        db.rename_column('cms_cmsplugin', 'new_placeholder_id', 'placeholder_id')

        # Deleting field 'CMSPlugin.page'
        db.delete_column('cms_cmsplugin', 'page_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CMSPlugin.placeholder'
