...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tagging_synonym', (
        ...
        db.send_create_signal('tagging', ['Synonym'])


    def backwards(self, orm):
        # Deleting model 'Synonym'
        db.delete_table('tagging_synonym')
    ...
    models = {
        ...
        'tagging.synonym': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'synonyms'", 'to': "orm['tagging.Tag']"})
        },
        'tagging.tag': {
