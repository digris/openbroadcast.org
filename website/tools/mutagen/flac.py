...
from mutagen._util import resize_bytes, MutagenError, get_size, loadfile, convert_error
...
class CueSheetTrackIndex(tuple):
    ...
    def __new__(cls, index_number, index_offset):
        return super(cls, CueSheetTrackIndex).__new__(cls, (index_number, index_offset))
...
class CueSheetTrack(object):
    ...
    def __repr__(self):
        return (
            "<%s number=%r, offset=%d, isrc=%r, type=%r, "
