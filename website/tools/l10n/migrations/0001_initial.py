    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('continent', models.CharField(max_length=2, verbose_name='Continent', choices=[(b'AF', 'Africa'), (b'NA', 'North America'), (b'EU', 'Europe'), (b'AS', 'Asia'), (b'OC', 'Oceania'), (b'SA', 'South America'), (b'AN', 'Antarctica'), (b'WX', 'Worldwide')])),
