...
class Address(models.Model):
    ...
    user_billing = models.OneToOneField(
        settings.AUTH_USER_MODEL, related_name="billing_address", blank=True, null=True
    )
    ...
    country = models.ForeignKey(
        Country, limit_choices_to={"active": True}, verbose_name=_("country")
    )
