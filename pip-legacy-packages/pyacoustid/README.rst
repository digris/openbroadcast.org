...
Originally taken from https://github.com/sampsyo/pyacoustid

This version contains just a small adaption to not use *audioread*. We did experience problems with *audioread*
when using *acoustid._fingerprint_file_fpcalc* in background tasks (celery).
