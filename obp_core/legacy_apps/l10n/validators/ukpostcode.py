"""From http://code.activestate.com/recipes/279004/"""
import re
...
THIRD_POS_CHARS = ["A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "S", "T", "U", "W"]
FOURTH_POS_CHARS = ["A", "B", "E", "H", "M", "N", "P", "R", "V", "W", "X", "Y"]
INCODE_CHARS = [
    "A",
    "B",
    "D",
...
INCODE_PATTERN = r"(\d[" + "".join(INCODE_CHARS) + r"][" + "".join(INCODE_CHARS) + r"])"
