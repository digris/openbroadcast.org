...
class NumericTextFrame(TextFrame):
    ...
    _framespec = [
        EncodingSpec("encoding", default=Encoding.UTF16),
        MultiSpec("text", EncodedNumericTextSpec("text"), sep="\u0000", default=[]),
    ]
...
class NumericPartTextFrame(TextFrame):
    ...
    _framespec = [
        EncodingSpec("encoding", default=Encoding.UTF16),
        MultiSpec(
            "text", EncodedNumericPartTextSpec("text"), sep="\u0000", default=[]
        ),
    ]
...
class PRIV(Frame):
    ...
    @property
    def HashKey(self):
        return "{}:{}:{}".format(self.FrameID, self.owner, _bytes2key(self.data))
